...
const ABI_VERSION: &str = "0x0001000f";
...
pub struct RootfsIsolationProbeRequest<'a> {
    ...
    pub model_buckling_model: &'a Path,
    pub model_buckling_request_root: &'a Path,
    pub model_buckling_direct_root: &'a Path,
    pub model_buckling_resumed_root: &'a Path,
    pub model_buckling_view_source_before: &'a Path,
    pub model_buckling_direct_stdout: &'a Path,
    pub model_buckling_resumed_stdout: &'a Path,
    pub model_buckling_result_view_en_us_first: &'a Path,
    pub model_buckling_result_view_en_us_second: &'a Path,
    pub model_buckling_result_view_ko_kr_first: &'a Path,
    pub model_buckling_result_view_ko_kr_second: &'a Path,
    pub model_buckling_result_view_invalid_window_failure: &'a Path,
    pub model_buckling_workbench_restarted_root: &'a Path,
    pub model_buckling_workbench_direct_root: &'a Path,
    pub model_buckling_workbench_reconciled_stdout: &'a Path,
    ...
    pub frame3d_end_release_model: &'a Path,
    pub frame3d_end_release_request_root: &'a Path,
    pub frame3d_end_release_direct_root: &'a Path,
    pub frame3d_end_release_partial_root: &'a Path,
    pub frame3d_end_release_resumed_root: &'a Path,
    pub frame3d_self_weight_model: &'a Path,
    pub frame3d_self_weight_request_root: &'a Path,
    ...
    pub frame3d_prescribed_support_model: &'a Path,
    pub frame3d_prescribed_support_edit_root: &'a Path,
    pub frame3d_prescribed_support_combination_root: &'a Path,
    pub frame3d_prescribed_support_request_root: &'a Path,
    pub frame3d_prescribed_support_direct_root: &'a Path,
    pub frame3d_prescribed_support_partial_root: &'a Path,
    pub frame3d_prescribed_support_resumed_root: &'a Path,
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[allow(clippy::struct_excessive_bools)]
pub struct RootfsIsolationEvidenceV16 {
    #[serde(flatten)]
    pub prior: RootfsIsolationEvidenceV15,
    pub model_ir_frame3d_end_release_linear_cpu_surface_passed: bool,
    pub model_ir_frame3d_end_release_linear_cpu_restart_bitwise_passed: bool,
    pub model_ir_frame3d_end_release_linear_cpu_fallback_count: u32,
    pub model_ir_frame3d_end_release_released_force_exact_zero_passed: bool,
    pub model_ir_frame3d_end_release_model_sha256: String,
    pub model_ir_frame3d_end_release_request_sha256: String,
    pub model_ir_frame3d_end_release_result_ir_sha256: String,
    pub model_ir_frame3d_end_release_recovery_sha256: String,
    pub model_ir_frame3d_end_release_checkpoint_sha256: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct RootfsIsolationReceiptV16 {
    pub schema_version: String,
    pub evidence: RootfsIsolationEvidenceV16,
    pub receipt_hash: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[allow(clippy::struct_excessive_bools)]
pub struct RootfsIsolationEvidenceV17 {
    #[serde(flatten)]
    pub prior: RootfsIsolationEvidenceV16,
    pub model_ir_self_weight_linear_cpu_surface_passed: bool,
    pub model_ir_self_weight_linear_cpu_restart_bitwise_passed: bool,
    pub model_ir_self_weight_linear_cpu_fallback_count: u32,
    pub model_ir_self_weight_standard_gravity_passed: bool,
    pub model_ir_self_weight_closed_form_tip_displacement_passed: bool,
    pub model_ir_self_weight_model_sha256: String,
    pub model_ir_self_weight_request_sha256: String,
    pub model_ir_self_weight_result_ir_sha256: String,
    pub model_ir_self_weight_recovery_sha256: String,
    pub model_ir_self_weight_reaction_sha256: String,
    pub model_ir_self_weight_checkpoint_sha256: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct RootfsIsolationReceiptV17 {
    pub schema_version: String,
    pub evidence: RootfsIsolationEvidenceV17,
    pub receipt_hash: String,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[allow(clippy::struct_excessive_bools)]
pub struct RootfsIsolationEvidenceV19 {
    #[serde(flatten)]
    pub prior: RootfsIsolationEvidenceV18,
    pub model_ir_frame3d_prescribed_support_linear_cpu_surface_passed: bool,
    pub model_ir_frame3d_prescribed_support_linear_cpu_restart_bitwise_passed: bool,
    pub model_ir_frame3d_prescribed_support_linear_cpu_fallback_count: u32,
    pub model_ir_frame3d_prescribed_support_effective_rhs_passed: bool,
    pub model_ir_frame3d_prescribed_support_terminal_displacement_passed: bool,
    pub model_ir_frame3d_prescribed_support_reaction_passed: bool,
    pub model_ir_frame3d_prescribed_support_model_sha256: String,
    pub model_ir_frame3d_prescribed_support_edit_receipt_sha256: String,
    pub model_ir_frame3d_prescribed_support_combination_receipt_sha256: String,
    pub model_ir_frame3d_prescribed_support_request_sha256: String,
    pub model_ir_frame3d_prescribed_support_result_ir_sha256: String,
    pub model_ir_frame3d_prescribed_support_recovery_sha256: String,
    pub model_ir_frame3d_prescribed_support_reaction_sha256: String,
    pub model_ir_frame3d_prescribed_support_checkpoint_sha256: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct RootfsIsolationReceiptV19 {
    pub schema_version: String,
    pub evidence: RootfsIsolationEvidenceV19,
    pub receipt_hash: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[allow(clippy::struct_excessive_bools)]
pub struct RootfsIsolationEvidenceV20 {
    #[serde(flatten)]
    pub prior: RootfsIsolationEvidenceV19,
    pub workbench_model_buckling_request_create_surface_passed: bool,
    pub model_ir_buckling_product_surface_passed: bool,
    pub model_ir_buckling_restart_surface_passed: bool,
    pub model_ir_buckling_restart_bitwise_passed: bool,
    pub workbench_model_buckling_result_view_surface_passed: bool,
    pub workbench_model_buckling_result_view_read_only_passed: bool,
    pub workbench_model_buckling_result_view_invalid_window_rejected: bool,
    pub workbench_model_buckling_durable_session_surface_passed: bool,
    pub workbench_model_buckling_durable_session_crash_reconciliation_passed: bool,
    pub workbench_model_buckling_durable_session_restart_bitwise_passed: bool,
    pub workbench_model_buckling_durable_session_tamper_rejected: bool,
    pub workbench_model_buckling_durable_session_null_authority_passed: bool,
    pub model_ir_buckling_mode_count: u32,
    pub model_ir_buckling_active_dof_count: u32,
    pub model_ir_buckling_fallback_count: u32,
    pub model_ir_buckling_model_sha256: String,
    pub model_ir_buckling_request_sha256: String,
    pub workbench_model_buckling_request_receipt_sha256: String,
    pub model_ir_buckling_checkpoint_sha256: String,
    pub model_ir_buckling_result_ir_sha256: String,
    pub model_ir_buckling_run_receipt_sha256: String,
    pub workbench_model_buckling_result_view_en_us_sha256: String,
    pub workbench_model_buckling_result_view_ko_kr_sha256: String,
    pub workbench_model_buckling_durable_session_sha256: String,
    pub workbench_model_buckling_durable_validation_receipt_sha256: String,
    pub workbench_model_buckling_durable_report_receipt_sha256: String,
    pub workbench_model_buckling_durable_inspect_sha256: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
#[serde(deny_unknown_fields)]
pub struct RootfsIsolationReceiptV20 {
    pub schema_version: String,
    pub evidence: RootfsIsolationEvidenceV20,
    pub receipt_hash: String,
}
...
pub fn create_rootfs_isolation_receipt(
    ...
    let frame3d_prescribed_support_surface =
        inspect_rootfs_frame3d_prescribed_support_surface(&workspace, request)?;
    ...
    ROOTFS_RECEIPT_CLAIM_BOUNDARY_V15.clone_into(
        &mut evidence_v14
            .prior
            .prior
            .prior
    ...
    let mut evidence_v15 = RootfsIsolationEvidenceV15 {
        prior: evidence_v14,
    ...
    validate_rootfs_isolation_evidence_v15(&evidence_v15)?;
    ROOTFS_RECEIPT_CLAIM_BOUNDARY_V16.clone_into(
        &mut evidence_v15
            .prior
            .prior
            .prior
    ...
    let mut end_release_evidence = RootfsIsolationEvidenceV16 {
        prior: evidence_v15,
        ...
        model_ir_frame3d_end_release_model_sha256: frame3d_end_release_surface.model_sha256,
        model_ir_frame3d_end_release_request_sha256: frame3d_end_release_surface.request_sha256,
        model_ir_frame3d_end_release_result_ir_sha256: frame3d_end_release_surface.result_ir_sha256,
        model_ir_frame3d_end_release_recovery_sha256: frame3d_end_release_surface.recovery_sha256,
        model_ir_frame3d_end_release_checkpoint_sha256: frame3d_end_release_surface
            .checkpoint_sha256,
    };
    ...
    let mut self_weight_evidence = RootfsIsolationEvidenceV17 {
        ...
        model_ir_self_weight_model_sha256: frame3d_self_weight_surface.model_sha256,
        model_ir_self_weight_request_sha256: frame3d_self_weight_surface.request_sha256,
        model_ir_self_weight_result_ir_sha256: frame3d_self_weight_surface.result_ir_sha256,
        model_ir_self_weight_recovery_sha256: frame3d_self_weight_surface.recovery_sha256,
    ...
    ROOTFS_RECEIPT_CLAIM_BOUNDARY_V18.clone_into(
    ...
    let mut member_load_evidence = evidence;
    ROOTFS_RECEIPT_CLAIM_BOUNDARY_V19.clone_into(
        &mut member_load_evidence
            .prior
            .prior
            .prior
            .prior
    ...
    let prescribed_support_evidence = RootfsIsolationEvidenceV19 {
        prior: member_load_evidence,
        ...
        model_ir_frame3d_prescribed_support_model_sha256: frame3d_prescribed_support_surface
            .model_sha256,
        model_ir_frame3d_prescribed_support_edit_receipt_sha256: frame3d_prescribed_support_surface
            .edit_receipt_sha256,
        model_ir_frame3d_prescribed_support_combination_receipt_sha256:
            frame3d_prescribed_support_surface.combination_receipt_sha256,
        model_ir_frame3d_prescribed_support_request_sha256: frame3d_prescribed_support_surface
            .request_sha256,
        model_ir_frame3d_prescribed_support_result_ir_sha256: frame3d_prescribed_support_surface
            .result_ir_sha256,
        model_ir_frame3d_prescribed_support_recovery_sha256: frame3d_prescribed_support_surface
            .recovery_sha256,
        model_ir_frame3d_prescribed_support_reaction_sha256: frame3d_prescribed_support_surface
            .reaction_sha256,
        model_ir_frame3d_prescribed_support_checkpoint_sha256: frame3d_prescribed_support_surface
            .checkpoint_sha256,
    };
    ...
    let evidence = RootfsIsolationEvidenceV20 {
        prior,
        ...
        model_ir_buckling_model_sha256: model_buckling_surface.model_sha256,
        model_ir_buckling_request_sha256: model_buckling_surface.request_sha256,
        workbench_model_buckling_request_receipt_sha256: model_buckling_surface
            .request_receipt_sha256,
        model_ir_buckling_checkpoint_sha256: model_buckling_surface.checkpoint_sha256,
        model_ir_buckling_result_ir_sha256: model_buckling_surface.result_ir_sha256,
        model_ir_buckling_run_receipt_sha256: model_buckling_surface.run_receipt_sha256,
        workbench_model_buckling_result_view_en_us_sha256: model_buckling_surface.view_en_us_sha256,
        workbench_model_buckling_result_view_ko_kr_sha256: model_buckling_surface.view_ko_kr_sha256,
        workbench_model_buckling_durable_session_sha256: model_buckling_workbench_surface
            .session_sha256,
        workbench_model_buckling_durable_validation_receipt_sha256:
            model_buckling_workbench_surface.validation_receipt_sha256,
        workbench_model_buckling_durable_report_receipt_sha256: model_buckling_workbench_surface
            .report_receipt_sha256,
        workbench_model_buckling_durable_inspect_sha256: model_buckling_workbench_surface
            .inspect_sha256,
    };
...
pub fn verify_rootfs_isolation_receipt(
        ...
        .and_then(serde_json::Value::as_str)
    {
        ...
        Some(ROOTFS_RECEIPT_SCHEMA_VERSION_V15) => {
        ...
        Some(ROOTFS_RECEIPT_SCHEMA_VERSION_V16) => {
            let receipt: RootfsIsolationReceiptV16 =
                read_canonical_json(receipt_path, MAX_MANIFEST_BYTES)?;
            validate_rootfs_isolation_evidence_v16(&receipt.evidence)?;
            verify_rootfs_receipt_hash(&receipt.evidence, &receipt.receipt_hash)?;
            let base = &receipt
                .evidence
                .prior
            ...
            require_manifest_entry_hash(
                &manifest,
                "bin/structural-cli",
                &receipt.evidence.prior.prior.prior.structural_cli_sha256,
            )?;
        ...
        Some(ROOTFS_RECEIPT_SCHEMA_VERSION_V18) => {
        ...
        Some(ROOTFS_RECEIPT_SCHEMA_VERSION_V19) => {
            let receipt: RootfsIsolationReceiptV19 =
                read_canonical_json(receipt_path, MAX_MANIFEST_BYTES)?;
            validate_rootfs_isolation_evidence_v19(&receipt.evidence)?;
            verify_rootfs_receipt_hash(&receipt.evidence, &receipt.receipt_hash)?;
            let base = &receipt
                .evidence
                .prior
...
#[allow(clippy::struct_field_names)]
struct ModelBucklingSurfaceSummary {
    model_sha256: String,
    request_sha256: String,
    request_receipt_sha256: String,
    checkpoint_sha256: String,
...
#[allow(clippy::struct_field_names)]
struct ModelBucklingWorkbenchSurfaceSummary {
    session_sha256: String,
    validation_receipt_sha256: String,
    report_receipt_sha256: String,
    inspect_sha256: String,
...
#[allow(clippy::struct_field_names)]
struct Frame3dEndReleaseSurfaceSummary {
    model_sha256: String,
    request_sha256: String,
    result_ir_sha256: String,
    recovery_sha256: String,
...
#[allow(clippy::struct_field_names)]
struct Frame3dPrescribedSupportSurfaceSummary {
    model_sha256: String,
    edit_receipt_sha256: String,
    combination_receipt_sha256: String,
    request_sha256: String,
    result_ir_sha256: String,
    recovery_sha256: String,
    reaction_sha256: String,
...
fn inspect_model_buckling_view_artifact(
    workspace: &Path,
    path: &Path,
    locale: &str,
    label: &str,
    ...
    if bytes.contains(&0x1b) {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_unsafe",
            format!("{label} contains an ANSI escape byte"),
        ));
    }
    let text = std::str::from_utf8(&bytes).map_err(|_| {
        DistributionError::new(
            "rootfs_model_buckling_view_invalid",
            format!("{label} must be UTF-8"),
        )
    })?;
    let without_final_newline = text.strip_suffix('\n').ok_or_else(|| {
        DistributionError::new(
            "rootfs_model_buckling_view_noncanonical",
            format!("{label} must end with one newline"),
        )
    })?;
    let final_line_start = without_final_newline
        ...
        .map_or(0, |position| position + 1);
    let final_line = &without_final_newline[final_line_start..];
    let (hash_label, schema_line, locale_line) = match locale {
        "en-US" => (
            "View hash: ",
            "Schema: structural-native-workbench-model-ir-linear-buckling-result-view.v1",
            "Locale: en-US",
        ),
        "ko-KR" => (
            "보기 해시: ",
            "스키마: structural-native-workbench-model-ir-linear-buckling-result-view.v1",
            "로케일: ko-KR",
        ),
        _ => {
            return Err(DistributionError::new(
                "rootfs_model_buckling_view_invalid",
                "buckling result view locale contract is unsupported",
            ));
        }
    };
    let declared_hash = final_line.strip_prefix(hash_label).ok_or_else(|| {
        DistributionError::new(
            "rootfs_model_buckling_view_hash_missing",
            format!("{label} has no terminal self-hash"),
        )
    })?;
    validate_sha256_identity(declared_hash, "rootfs buckling result view self-hash")?;
    if declared_hash != sha256_identity(&bytes[..final_line_start]) {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_hash_mismatch",
            format!("{label} self-hash does not verify"),
        ));
    }
    let mode_rows = text
    ...
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_contract_invalid",
            format!("{label} does not expose the exact bounded buckling view contract"),
        ));
    }
...
fn inspect_model_buckling_invalid_window_failure(
    workspace: &Path,
    path: &Path,
) -> Result<(), DistributionError> {
    let bytes =
        read_direct_workspace_file(workspace, path, "invalid-window buckling view failure")?;
    let canonical = bytes.strip_suffix(b"\n").ok_or_else(|| {
        DistributionError::new(
            "rootfs_model_buckling_view_failure_noncanonical",
            "invalid-window buckling view failure must be one JSON line",
        )
    })?;
    let value = structural_contracts::model_ir::decode_json_strict(canonical).map_err(|error| {
        DistributionError::new(
            "rootfs_model_buckling_view_failure_invalid",
            format!("invalid-window buckling view failure is invalid JSON: {error}"),
        )
    })?;
    let expected = ["code", "detail", "schema_version"]
        .into_iter()
    ...
    if value
        ...
        || value
            ...
            != Some("structural-native-workbench-failure.v1")
        || value.get("code").and_then(serde_json::Value::as_str)
            != Some("workbench_buckling_result_view_window_invalid")
        || value
            .get("detail")
            .and_then(serde_json::Value::as_str)
            .map_or(true, str::is_empty)
        || compact_operator_json(&value)? != canonical
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_failure_invalid",
            "invalid-window buckling view failure does not match the fail-closed contract",
        ));
    }
    Ok(())
}
...
#[allow(clippy::too_many_lines)]
fn inspect_rootfs_model_buckling_surface(
    workspace: &Path,
    request: &RootfsIsolationProbeRequest<'_>,
) -> Result<ModelBucklingSurfaceSummary, DistributionError> {
    const REQUEST_ARTIFACTS: [&str; 2] = ["analysis-request.json", "request-receipt.json"];
    const RESULT_ARTIFACTS: [&str; 18] = [
    ...
    let model_bytes = read_direct_workspace_file(
        workspace,
        request.model_buckling_model,
        "ModelIR buckling model",
    )?;
    let model =
        structural_contracts::model_ir::parse_model_ir_v2(&model_bytes).map_err(|error| {
            DistributionError::new(
                "rootfs_model_buckling_model_invalid",
                format!("rootfs buckling ModelIR failed strict verification: {error}"),
            )
        })?;
    if model.model_id() != "engine-v2-frame-cantilever-buckling"
        || model
            .value()
            .pointer("/load_patterns/0/nodal_loads/0/components_si/FX")
            .and_then(serde_json::Value::as_f64)
            != Some(-100_000.0)
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_model_invalid",
            "rootfs buckling ModelIR is not the exact compressed Frame3D cantilever",
        ));
    }
    let request_artifacts = inspect_exact_modal_directory(
        workspace,
        request.model_buckling_request_root,
        &REQUEST_ARTIFACTS,
        "ModelIR buckling request directory",
    )?;
    let direct = inspect_exact_modal_directory(
        workspace,
        request.model_buckling_direct_root,
        &RESULT_ARTIFACTS,
        "direct ModelIR buckling result directory",
    )?;
    let resumed = inspect_exact_modal_directory(
        workspace,
        request.model_buckling_resumed_root,
        &RESULT_ARTIFACTS,
        "resumed ModelIR buckling result directory",
    )?;
    let before_view = inspect_exact_modal_directory(
        workspace,
        request.model_buckling_view_source_before,
        &RESULT_ARTIFACTS,
        "pre-view ModelIR buckling result snapshot",
    )?;
    if direct != resumed {
        return Err(DistributionError::new(
            "rootfs_model_buckling_restart_mismatch",
            "direct and resumed ModelIR buckling result directories differ",
        ));
    }
    if direct != before_view {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_mutated_source",
            "buckling result view mutated its source directory",
        ));
    }
    let direct_stdout = read_direct_workspace_file(
        workspace,
        request.model_buckling_direct_stdout,
        "direct ModelIR buckling stdout",
    )?;
    let resumed_stdout = read_direct_workspace_file(
        workspace,
        request.model_buckling_resumed_stdout,
        "resumed ModelIR buckling stdout",
    )?;
    if direct_stdout != resumed_stdout {
        return Err(DistributionError::new(
            "rootfs_model_buckling_restart_mismatch",
            "direct and resumed ModelIR buckling stdout differs",
        ));
    }
    let executed_model =
        structural_contracts::model_ir::parse_model_ir_v2(&direct[7]).map_err(|error| {
            DistributionError::new(
                "rootfs_model_buckling_model_invalid",
                format!("executed buckling ModelIR failed strict verification: {error}"),
            )
        })?;
    if executed_model.content_hash() != model.content_hash()
        || executed_model.semantic_hash() != model.semantic_hash()
        || executed_model.provenance_hash() != model.provenance_hash()
        || direct[6] != request_artifacts[0]
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_binding_mismatch",
            "buckling product does not bind the exact model and authored request",
        ));
    }
    let request_receipt = structural_contracts::model_ir::decode_json_strict(&request_artifacts[1])
        .map_err(|error| {
            DistributionError::new(
                "rootfs_model_buckling_request_receipt_invalid",
                format!("buckling request receipt is invalid JSON: {error}"),
            )
        })?;
    if request_receipt
        .get("schema_version")
        .and_then(serde_json::Value::as_str)
        != Some("structural-native-model-linear-buckling-request-create-receipt.v1")
        || request_receipt
            .get("active_dof_count")
            .and_then(serde_json::Value::as_u64)
            != Some(6)
        || request_receipt
            .get("native_reference_pcg_recovery_reaction_preflight_executed")
            .and_then(serde_json::Value::as_bool)
            != Some(true)
        || request_receipt
            .get("native_v1_15_k_kg_preflight_executed")
            .and_then(serde_json::Value::as_bool)
            != Some(true)
        || request_receipt
            .get("dense_buckling_preflight_executed")
            .and_then(serde_json::Value::as_bool)
            != Some(true)
        || request_receipt
            ...
            != Some(false)
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_request_receipt_invalid",
            "buckling request receipt does not match the exact preflight contract",
        ));
    }
    let result =
        structural_contracts::spectral_product::parse_dense_spectral_result_ir_v1(&direct[16])
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_model_buckling_result_invalid",
                    format!("rootfs buckling ResultIR failed strict verification: {error}"),
                )
            })?;
    if result.result().summary.mode_count != 2
        || result.result().modes.len() != 2
        || result.result().backend_receipt.fallback_count != 0
        || result.result().analysis_kind
            != structural_contracts::spectral_product::SpectralAnalysisKindV1::LinearBuckling
        || result
            .result()
            .summary
            ...
            .map_or(true, |value| !value.is_finite() || value <= 0.0)
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_result_invalid",
            "rootfs buckling ResultIR does not match the exact two-mode CPU contract",
        ));
    }
    let run_receipt =
        structural_contracts::model_ir::decode_json_strict(&direct[17]).map_err(|error| {
            DistributionError::new(
                "rootfs_model_buckling_receipt_invalid",
                format!("rootfs buckling run receipt is invalid JSON: {error}"),
            )
        })?;
    if run_receipt
        .get("schema_version")
        .and_then(serde_json::Value::as_str)
        != Some("structural-model-ir-linear-buckling-run-receipt.v1")
        || run_receipt
            .get("status")
            .and_then(serde_json::Value::as_str)
            != Some("completed")
        ...
        || run_receipt
            .get("artifacts")
            .and_then(serde_json::Value::as_array)
            .map_or(true, |artifacts| artifacts.len() != 17)
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_receipt_invalid",
            "rootfs buckling run receipt does not match the completed bounded contract",
        ));
    }
    let en_us_first = inspect_model_buckling_view_artifact(
        workspace,
        request.model_buckling_result_view_en_us_first,
        "en-US",
        "first en-US buckling result view",
    )?;
    let en_us_second = inspect_model_buckling_view_artifact(
        workspace,
        request.model_buckling_result_view_en_us_second,
        "en-US",
        "second en-US buckling result view",
    )?;
    let ko_kr_first = inspect_model_buckling_view_artifact(
        workspace,
        request.model_buckling_result_view_ko_kr_first,
        "ko-KR",
        "first ko-KR buckling result view",
    )?;
    let ko_kr_second = inspect_model_buckling_view_artifact(
        workspace,
        request.model_buckling_result_view_ko_kr_second,
        "ko-KR",
        "second ko-KR buckling result view",
    )?;
    if en_us_first.0 != en_us_second.0 || ko_kr_first.0 != ko_kr_second.0 {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_determinism_failed",
            "repeated buckling result views differ",
        ));
    }
    if en_us_first.1 == ko_kr_first.1 {
        return Err(DistributionError::new(
            "rootfs_model_buckling_view_locale_collision",
            "buckling result view locales have the same identity",
        ));
    }
    inspect_model_buckling_invalid_window_failure(
        workspace,
        request.model_buckling_result_view_invalid_window_failure,
    )?;
    Ok(ModelBucklingSurfaceSummary {
        model_sha256: sha256_identity(model.canonical_bytes()),
        request_sha256: sha256_identity(&request_artifacts[0]),
        request_receipt_sha256: sha256_identity(&request_artifacts[1]),
        checkpoint_sha256: sha256_identity(&direct[2]),
        result_ir_sha256: sha256_identity(&direct[16]),
        run_receipt_sha256: sha256_identity(&direct[17]),
        view_en_us_sha256: en_us_first.1,
        view_ko_kr_sha256: ko_kr_first.1,
    })
}
...
#[allow(clippy::too_many_lines)]
fn inspect_rootfs_frame3d_end_release_surface(
    workspace: &Path,
    request: &RootfsIsolationProbeRequest<'_>,
) -> Result<Frame3dEndReleaseSurfaceSummary, DistributionError> {
    const REQUEST_ARTIFACTS: [&str; 2] = ["analysis-request.json", "request-receipt.json"];
    const RESULT_ARTIFACTS: [&str; 15] = [
        "assembly-receipt.json",
        "checkpoint-receipt.json",
    ...
    let model_bytes = read_direct_workspace_file(
        workspace,
        request.frame3d_end_release_model,
        "Frame3D end-release ModelIR",
    )?;
    let request_artifacts = inspect_exact_linear_directory(
        workspace,
        request.frame3d_end_release_request_root,
        &REQUEST_ARTIFACTS,
        "Frame3D end-release request directory",
    )?;
    let direct = inspect_exact_linear_directory(
        workspace,
        request.frame3d_end_release_direct_root,
        &RESULT_ARTIFACTS,
        "direct Frame3D end-release result directory",
    )?;
    let partial = inspect_exact_linear_directory(
        workspace,
        request.frame3d_end_release_partial_root,
        &PARTIAL_ARTIFACTS,
        "partial Frame3D end-release result directory",
    )?;
    let resumed = inspect_exact_linear_directory(
        workspace,
        request.frame3d_end_release_resumed_root,
        &RESULT_ARTIFACTS,
        "resumed Frame3D end-release result directory",
    )?;
    if direct != resumed {
        return Err(DistributionError::new(
            "rootfs_frame3d_end_release_restart_mismatch",
            "direct and resumed Frame3D end-release result directories differ",
        ));
    }
    let model =
        structural_contracts::model_ir::parse_model_ir_v2(&model_bytes).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_model_invalid",
                format!("Frame3D end-release ModelIR failed strict verification: {error}"),
            )
        })?;
    let vector_matches = |pointer: &str, expected: [f64; 3]| {
        model
    ...
    let releases = model.value()["elements"][0]["releases"]["i"].as_array();
    let constraints = model.value()["constraints"].as_array();
    if model.model_id() != "engine-v2-frame-cantilever-end-release"
        || model.value()["elements"].as_array().map(Vec::len) != Some(1)
        || model.value()["elements"][0]["type"].as_str() != Some("frame_3d")
        || !vector_matches("/elements/0/offsets/i_global_m", [0.1, 0.0, 0.0])
        || !vector_matches("/elements/0/offsets/j_global_m", [-0.1, 0.0, 0.0])
        || releases.map_or(true, |items| {
            items.len() != 1 || items[0].as_str() != Some("RY")
        })
        || constraints.map_or(true, |items| {
            !items.iter().any(|item| {
                item["id"].as_str() == Some("BC2")
                    && item["node_id"].as_str() == Some("N2")
                    && item["dofs"]
                        .as_array()
                        .is_some_and(|dofs| dofs.len() == 1 && dofs[0].as_str() == Some("UZ"))
            })
        })
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_end_release_model_invalid",
            "rootfs ModelIR does not contain the exact constrained i-end RY release case",
        ));
    }
    for execution_model_bytes in [&direct[7], &partial[7]] {
        let execution_model = structural_contracts::model_ir::parse_model_ir_v2(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_binding_mismatch",
                format!("executed Frame3D end-release ModelIR is invalid: {error}"),
            )
        })?;
        if execution_model.content_hash() != model.content_hash()
            || execution_model.semantic_hash() != model.semantic_hash()
            || execution_model.provenance_hash() != model.provenance_hash()
        {
            return Err(DistributionError::new(
                "rootfs_frame3d_end_release_binding_mismatch",
                "executed Frame3D end-release ModelIR identities drifted",
            ));
        }
    }
    let analysis_request =
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_request_invalid",
                format!("Frame3D end-release request failed strict verification: {error}"),
            )
        })?;
    let identity = &analysis_request.request().model_identity;
    if analysis_request.request().case_id != "model-frame-end-release-linear-c5"
        || analysis_request.request().load_pattern_id != "LC_WEAK"
        || identity.content_hash != model.content_hash()
        || identity.semantic_hash != model.semantic_hash()
        || identity.provenance_hash != model.provenance_hash()
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_end_release_request_invalid",
            "Frame3D end-release request does not bind the exact model and case",
        ));
    }
    for execution_request_bytes in [&direct[5], &partial[5]] {
        let execution_request =
            ...
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_end_release_binding_mismatch",
                    format!("executed Frame3D end-release request is invalid: {error}"),
                )
            })?;
        if execution_request.request_hash() != analysis_request.request_hash() {
            return Err(DistributionError::new(
                "rootfs_frame3d_end_release_binding_mismatch",
                "executed Frame3D end-release request identity drifted",
            ));
        }
    }
    let direct_receipt =
        structural_contracts::model_ir::decode_json_strict(&direct[13]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_receipt_invalid",
                format!("direct Frame3D end-release receipt is invalid JSON: {error}"),
            )
        })?;
    let partial_receipt =
        structural_contracts::model_ir::decode_json_strict(&partial[8]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_receipt_invalid",
                format!("partial Frame3D end-release receipt is invalid JSON: {error}"),
            )
        })?;
    if direct_receipt["schema_version"].as_str()
        != Some("structural-model-ir-linear-run-receipt.v1")
        ...
        || partial_receipt["status"].as_str() != Some("active")
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_end_release_receipt_invalid",
            "Frame3D end-release direct/partial status contract is invalid",
        ));
    }
    let result =
        structural_contracts::sparse_product::parse_sparse_linear_result_ir_v1(&direct[11])
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_end_release_result_invalid",
                    format!("Frame3D end-release ResultIR failed strict verification: {error}"),
                )
            })?;
    let recovery =
        structural_contracts::model_linear_recovery::parse_model_ir_linear_result_recovery_ir_v1(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_end_release_recovery_invalid",
                format!("Frame3D end-release recovery failed strict verification: {error}"),
            )
        })?;
    if result.result().backend_receipt.fallback_count != 0
        || recovery.recovery().fallback_count != 0
        ...
        || recovery.recovery().recovery_offsets != [0, 12]
        || recovery.recovery().recovery_values.len() != 12
        || recovery.recovery().recovery_values[4].to_bits() != 0
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_end_release_recovery_invalid",
            "Frame3D end-release result is not the exact fallback-free recovery with positive-zero released i-MY",
        ));
    }
    Ok(Frame3dEndReleaseSurfaceSummary {
        model_sha256: sha256_identity(&model_bytes),
        request_sha256: sha256_identity(&request_artifacts[0]),
        result_ir_sha256: sha256_identity(&direct[11]),
        recovery_sha256: sha256_identity(&direct[12]),
...
#[allow(clippy::too_many_lines)]
fn inspect_rootfs_frame3d_self_weight_surface(
    workspace: &Path,
    request: &RootfsIsolationProbeRequest<'_>,
) -> Result<Frame3dSelfWeightSurfaceSummary, DistributionError> {
    const REQUEST_ARTIFACTS: [&str; 2] = ["analysis-request.json", "request-receipt.json"];
    const RESULT_ARTIFACTS: [&str; 15] = [
        "assembly-receipt.json",
        "checkpoint-receipt.json",
    ...
    let model_bytes = read_direct_workspace_file(
        workspace,
        request.frame3d_self_weight_model,
        "Frame3D self-weight ModelIR",
    )?;
    let request_artifacts = inspect_exact_linear_directory(
        workspace,
        request.frame3d_self_weight_request_root,
        &REQUEST_ARTIFACTS,
        "Frame3D self-weight request directory",
    )?;
    let direct = inspect_exact_linear_directory(
        workspace,
        request.frame3d_self_weight_direct_root,
        &RESULT_ARTIFACTS,
        "direct Frame3D self-weight result directory",
    )?;
    let partial = inspect_exact_linear_directory(
        workspace,
        request.frame3d_self_weight_partial_root,
        &PARTIAL_ARTIFACTS,
        "partial Frame3D self-weight result directory",
    )?;
    let resumed = inspect_exact_linear_directory(
        workspace,
        request.frame3d_self_weight_resumed_root,
        &RESULT_ARTIFACTS,
        "resumed Frame3D self-weight result directory",
    )?;
    if direct != resumed {
        return Err(DistributionError::new(
            "rootfs_frame3d_self_weight_restart_mismatch",
            "direct and resumed Frame3D self-weight result directories differ",
        ));
    }
    let model =
        structural_contracts::model_ir::parse_model_ir_v2(&model_bytes).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_model_invalid",
                format!("Frame3D self-weight ModelIR failed strict verification: {error}"),
            )
        })?;
    let pattern = &model.value()["load_patterns"][1];
    let self_weight = pattern["self_weight"].as_array();
    let nodal_loads = pattern["nodal_loads"].as_array();
    if model.model_id() != "engine-v2-frame-cantilever-self-weight-installed"
        || model.value()["elements"].as_array().map(Vec::len) != Some(1)
        || model.value()["elements"][0]["type"].as_str() != Some("frame_3d")
        || pattern["id"].as_str() != Some("LC_WEAK")
        || self_weight.map_or(true, |values| {
            values.len() != 3
                || values[0].as_f64() != Some(0.0)
                || values[1].as_f64() != Some(0.0)
                || values[2].as_f64() != Some(-1.0)
        })
        || nodal_loads.map_or(true, |loads| {
            loads.len() != 1
                || loads[0]["node_id"].as_str() != Some("N2")
                || loads[0]["components_si"]["FY"].as_f64() != Some(-10_000.0)
        })
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_self_weight_model_invalid",
            "rootfs ModelIR does not contain the exact LC_WEAK nodal-load plus negative-Z self-weight case",
        ));
    }
    for execution_model_bytes in [&direct[7], &partial[7]] {
        let execution_model = structural_contracts::model_ir::parse_model_ir_v2(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_binding_mismatch",
                format!("executed Frame3D self-weight ModelIR is invalid: {error}"),
            )
        })?;
        if execution_model.content_hash() != model.content_hash()
            || execution_model.semantic_hash() != model.semantic_hash()
            || execution_model.provenance_hash() != model.provenance_hash()
        {
            return Err(DistributionError::new(
                "rootfs_frame3d_self_weight_binding_mismatch",
                "executed Frame3D self-weight ModelIR identities drifted",
            ));
        }
    }
    let analysis_request =
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_request_invalid",
                format!("Frame3D self-weight request failed strict verification: {error}"),
            )
        })?;
    let identity = &analysis_request.request().model_identity;
    if analysis_request.request().case_id != "model-frame-self-weight-linear-c5"
        || analysis_request.request().load_pattern_id != "LC_WEAK"
        || identity.content_hash != model.content_hash()
        || identity.semantic_hash != model.semantic_hash()
        || identity.provenance_hash != model.provenance_hash()
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_self_weight_request_invalid",
            "Frame3D self-weight request does not bind the exact model and case",
        ));
    }
    for execution_request_bytes in [&direct[5], &partial[5]] {
        let execution_request =
            ...
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_self_weight_binding_mismatch",
                    format!("executed Frame3D self-weight request is invalid: {error}"),
                )
            })?;
        if execution_request.request_hash() != analysis_request.request_hash() {
            return Err(DistributionError::new(
                "rootfs_frame3d_self_weight_binding_mismatch",
                "executed Frame3D self-weight request identity drifted",
            ));
        }
    }
    let direct_receipt =
        structural_contracts::model_ir::decode_json_strict(&direct[13]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_receipt_invalid",
                format!("direct Frame3D self-weight receipt is invalid JSON: {error}"),
            )
        })?;
    let partial_receipt =
        structural_contracts::model_ir::decode_json_strict(&partial[8]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_receipt_invalid",
                format!("partial Frame3D self-weight receipt is invalid JSON: {error}"),
            )
        })?;
    if direct_receipt["schema_version"].as_str()
        != Some("structural-model-ir-linear-run-receipt.v1")
        ...
        || partial_receipt["status"].as_str() != Some("active")
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_self_weight_receipt_invalid",
            "Frame3D self-weight direct/partial status contract is invalid",
        ));
    }
    let result =
        structural_contracts::sparse_product::parse_sparse_linear_result_ir_v1(&direct[11])
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_self_weight_result_invalid",
                    format!("Frame3D self-weight ResultIR failed strict verification: {error}"),
                )
            })?;
    let recovery =
        structural_contracts::model_linear_recovery::parse_model_ir_linear_result_recovery_ir_v1(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_recovery_invalid",
                format!("Frame3D self-weight recovery failed strict verification: {error}"),
            )
        })?;
    let reaction =
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_self_weight_reaction_invalid",
                format!("Frame3D self-weight reaction failed strict verification: {error}"),
            )
        })?;
    ...
    if result.result().backend_receipt.fallback_count != 0
        ...
        || (recovered.active_external_load[2] - -1_539.644_05).abs() > 1.0e-10
        || (recovered.active_external_load[4] - -513.214_683_333_333_3).abs() > 1.0e-10
        || (reactions.reactions[2] - 3_079.288_1).abs() > 1.0e-8
        || (reactions.reactions[4] - -3_079.288_1).abs() > 1.0e-8
        || (recovered.global_displacement[8] - -0.000_192_455_506_25).abs() > 1.0e-15
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_self_weight_result_invalid",
            "Frame3D self-weight result does not match the exact fallback-free gravity load, reaction and closed-form displacement contract",
        ));
    }
    Ok(Frame3dSelfWeightSurfaceSummary {
        model_sha256: sha256_identity(&model_bytes),
        request_sha256: sha256_identity(&request_artifacts[0]),
        result_ir_sha256: sha256_identity(&direct[11]),
        recovery_sha256: sha256_identity(&direct[12]),
...
#[allow(clippy::too_many_lines)]
fn inspect_rootfs_frame3d_prescribed_support_surface(
    workspace: &Path,
    request: &RootfsIsolationProbeRequest<'_>,
) -> Result<Frame3dPrescribedSupportSurfaceSummary, DistributionError> {
    const EDIT_ARTIFACTS: [&str; 2] = ["edit-receipt.json", "model-ir.json"];
    const REQUEST_ARTIFACTS: [&str; 2] = ["analysis-request.json", "request-receipt.json"];
    const RESULT_ARTIFACTS: [&str; 15] = [
        "assembly-receipt.json",
        "checkpoint-receipt.json",
    ...
    let model_bytes = read_direct_workspace_file(
        workspace,
        request.frame3d_prescribed_support_model,
        "Frame3D prescribed support ModelIR",
    )?;
    let edit = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_edit_root,
        &EDIT_ARTIFACTS,
        "Frame3D prescribed support edit directory",
    )?;
    let combination = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_combination_root,
        &EDIT_ARTIFACTS,
        "Frame3D prescribed support combination directory",
    )?;
    let request_artifacts = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_request_root,
        &REQUEST_ARTIFACTS,
        "Frame3D prescribed support request directory",
    )?;
    let direct = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_direct_root,
        &RESULT_ARTIFACTS,
        "direct Frame3D prescribed support result directory",
    )?;
    let partial = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_partial_root,
        &PARTIAL_ARTIFACTS,
        "partial Frame3D prescribed support result directory",
    )?;
    let resumed = inspect_exact_linear_directory(
        workspace,
        request.frame3d_prescribed_support_resumed_root,
        &RESULT_ARTIFACTS,
        "resumed Frame3D prescribed support result directory",
    )?;
    if direct != resumed {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_restart_mismatch",
            "direct and resumed Frame3D prescribed support result directories differ",
        ));
    }
    if combination[1] != model_bytes {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_binding_mismatch",
            "final Workbench-authored prescribed support model bytes drifted",
        ));
    }
    let model =
        structural_contracts::model_ir::parse_model_ir_v2(&model_bytes).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_model_invalid",
                format!("Frame3D prescribed support ModelIR failed strict verification: {error}"),
            )
        })?;
    let constraints = model.value()["constraints"].as_array();
    let combinations = model.value()["load_combinations"].as_array();
    if constraints.map_or(true, |rows| {
        rows.len() != 1
            || rows[0]["id"].as_str() != Some("BC1")
            || rows[0]["prescribed_values_si"]["UX"].as_f64() != Some(0.001)
    }) || combinations.map_or(true, |rows| {
        rows.iter()
            .find(|row| row["id"].as_str() == Some("COMBO_PRESCRIBED"))
            .map_or(true, |row| {
                row["terms"].as_array().map_or(true, |terms| {
                    terms.len() != 2
                        || terms[0]["ref_kind"].as_str() != Some("load_pattern")
                        || terms[0]["ref_id"].as_str() != Some("LC_AXIAL")
                        || terms[0]["factor"].as_f64() != Some(1.0)
                        || terms[1]["ref_kind"].as_str() != Some("load_pattern")
                        || terms[1]["ref_id"].as_str() != Some("LC_WEAK")
                        || terms[1]["factor"].as_f64() != Some(1.0)
                })
            })
    }) {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_model_invalid",
            "rootfs ModelIR does not contain the exact BC1.UX prescribed value and COMBO_PRESCRIBED terms",
        ));
    }
    let edit_receipt =
        structural_contracts::model_ir::decode_json_strict(&edit[0]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_edit_receipt_invalid",
                format!("prescribed support edit receipt is invalid: {error}"),
            )
        })?;
    let combination_receipt = structural_contracts::model_ir::decode_json_strict(&combination[0])
        .map_err(|error| {
        DistributionError::new(
            "rootfs_frame3d_prescribed_support_edit_receipt_invalid",
            format!("prescribed support combination receipt is invalid: {error}"),
        )
    })?;
    verify_operator_self_hash(
        &edit_receipt,
        "receipt_hash",
        "prescribed support edit receipt",
    )?;
    verify_operator_self_hash(
        &combination_receipt,
        "receipt_hash",
        "prescribed support combination receipt",
    )?;
    if edit_receipt["schema_version"].as_str() != Some("structural-native-model-edit-receipt.v1")
        || edit_receipt["operation"].as_str() != Some("constraint_prescribed_value")
        || edit_receipt["constraint_id"].as_str() != Some("BC1")
        || edit_receipt["dof"].as_str() != Some("UX")
        || edit_receipt["edited_value_si"].as_f64() != Some(0.001)
        || edit_receipt["analysis_ready"].as_bool() != Some(true)
        || edit_receipt["cpp_semantic_snapshot_verified"].as_bool() != Some(true)
        || combination_receipt["operation"].as_str() != Some("linear_load_combination_add")
        || combination_receipt["load_combination_id"].as_str() != Some("COMBO_PRESCRIBED")
        || combination_receipt["analysis_ready"].as_bool() != Some(true)
        || combination_receipt["cpp_semantic_snapshot_verified"].as_bool() != Some(true)
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_edit_receipt_invalid",
            "installed Workbench edit receipts do not bind the prescribed value and combination",
        ));
    }
    let analysis_request =
        structural_contracts::model_linear_product::parse_model_ir_linear_analysis_request_v1(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_request_invalid",
                format!("Frame3D prescribed support request failed strict verification: {error}"),
            )
        })?;
    let identity = &analysis_request.request().model_identity;
    if analysis_request.request().case_id != "model-frame-prescribed-support-linear-c5"
        || analysis_request.request().load_pattern_id != "COMBO_PRESCRIBED"
        || identity.content_hash != model.content_hash()
        || identity.semantic_hash != model.semantic_hash()
        || identity.provenance_hash != model.provenance_hash()
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_request_invalid",
            "Frame3D prescribed support request does not bind the exact model and combination",
        ));
    }
    for (execution_model_bytes, execution_request_bytes) in
        [(&direct[7], &direct[5]), (&partial[7], &partial[5])]
    {
        let execution_model = structural_contracts::model_ir::parse_model_ir_v2(
            execution_model_bytes,
        )
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_binding_mismatch",
                format!("executed prescribed support ModelIR is invalid: {error}"),
            )
        })?;
        let execution_request =
            structural_contracts::model_linear_product::parse_model_ir_linear_analysis_request_v1(
            ...
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_prescribed_support_binding_mismatch",
                    format!("executed prescribed support request is invalid: {error}"),
                )
            })?;
        if execution_model.content_hash() != model.content_hash()
            || execution_model.semantic_hash() != model.semantic_hash()
            || execution_model.provenance_hash() != model.provenance_hash()
            || execution_request.request_hash() != analysis_request.request_hash()
        {
            return Err(DistributionError::new(
                "rootfs_frame3d_prescribed_support_binding_mismatch",
                "executed prescribed support model or request identities drifted",
            ));
        }
    }
    let direct_receipt =
        structural_contracts::model_ir::decode_json_strict(&direct[13]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_receipt_invalid",
                format!("direct prescribed support receipt is invalid: {error}"),
            )
        })?;
    let partial_receipt =
        structural_contracts::model_ir::decode_json_strict(&partial[8]).map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_receipt_invalid",
                format!("partial prescribed support receipt is invalid: {error}"),
            )
        })?;
    if direct_receipt["status"].as_str() != Some("completed")
        || partial_receipt["status"].as_str() != Some("active")
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_receipt_invalid",
            "Frame3D prescribed support direct/partial status contract is invalid",
        ));
    }
    let result =
        structural_contracts::sparse_product::parse_sparse_linear_result_ir_v1(&direct[11])
            .map_err(|error| {
                DistributionError::new(
                    "rootfs_frame3d_prescribed_support_result_invalid",
                    format!("Frame3D prescribed support ResultIR failed verification: {error}"),
                )
            })?;
    let recovery =
        structural_contracts::model_linear_recovery::parse_model_ir_linear_result_recovery_ir_v1(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_recovery_invalid",
                format!("Frame3D prescribed support recovery failed verification: {error}"),
            )
        })?;
    let reaction =
        structural_contracts::model_linear_reactions::parse_model_ir_linear_reaction_result_ir_v1(
        ...
        .map_err(|error| {
            DistributionError::new(
                "rootfs_frame3d_prescribed_support_reaction_invalid",
                format!("Frame3D prescribed support reaction failed verification: {error}"),
            )
        })?;
    let recovered = recovery.recovery();
    let reactions = reaction.result();
    if result.result().backend_receipt.fallback_count != 0
        || recovered.fallback_count != 0
        || reactions.backend_receipt.fallback_count != 0
        || recovered.constrained_dof_indices != [0, 1, 2, 3, 4, 5]
        || recovered.prescribed_displacement_values.len() != 6
        || recovered.initial_active_internal_force.len() != 6
        || recovered.global_displacement.len() != 12
        || reactions.reactions.len() != 6
        || recovered.prescribed_displacement_values[0].to_bits() != 0.001_f64.to_bits()
        || recovered.prescribed_displacement_values[1..]
            .iter()
            .any(|value| *value != 0.0)
        || (recovered.initial_active_internal_force[0] - -2_000_000.0).abs() > 1.0e-9
        || recovered.initial_active_internal_force[1..]
            .iter()
            .any(|value| *value != 0.0)
        || recovered.global_displacement[0].to_bits() != 0.001_f64.to_bits()
        || (recovered.global_displacement[6] - 0.001_05).abs() > 1.0e-15
        || (reactions.reactions[0] - -100_000.0).abs() > 1.0e-7
    {
        return Err(DistributionError::new(
            "rootfs_frame3d_prescribed_support_result_invalid",
            "Frame3D prescribed support result does not match the exact fallback-free effective RHS, terminal displacement and reaction contract",
        ));
    }
    Ok(Frame3dPrescribedSupportSurfaceSummary {
        model_sha256: sha256_identity(&model_bytes),
        edit_receipt_sha256: sha256_identity(&edit[0]),
        combination_receipt_sha256: sha256_identity(&combination[0]),
        request_sha256: sha256_identity(&request_artifacts[0]),
        result_ir_sha256: sha256_identity(&direct[11]),
        recovery_sha256: sha256_identity(&direct[12]),
        reaction_sha256: sha256_identity(&direct[8]),
...
fn inspect_buckling_workbench_tree(
    workspace: &Path,
    root: &Path,
    label: &str,
) -> Result<Vec<(PathBuf, Vec<u8>)>, DistributionError> {
    const STAGE_FILES: [&str; 44] = [
        "01-import/import-receipt.json",
        "01-import/model-buckling-request.json",
        "01-import/model-ir.json",
        "02-validate/validation-receipt.json",
        "03-run/buckling-assembly-receipt.json",
        "03-run/checkpoint.eigcp",
        "03-run/checkpoint.mbcp",
        "03-run/dense-run-receipt.json",
        "03-run/generated-dense-request.json",
        "03-run/generated-reference-request.json",
        "03-run/model-buckling-request.json",
        "03-run/model-ir.json",
        "03-run/reference-assembly-receipt.json",
        "03-run/reference-checkpoint.mlpcp",
        "03-run/reference-checkpoint.pcgcp",
        "03-run/reference-reaction-ir.json",
        "03-run/reference-recovery-ir.json",
        "03-run/reference-result-ir.json",
        "03-run/report-ir.json",
        "03-run/report.md",
        "03-run/result-ir.json",
        "03-run/run-receipt.json",
        "04-resume/buckling-assembly-receipt.json",
        "04-resume/checkpoint.eigcp",
        "04-resume/checkpoint.mbcp",
        "04-resume/dense-run-receipt.json",
        "04-resume/generated-dense-request.json",
        "04-resume/generated-reference-request.json",
        "04-resume/model-buckling-request.json",
        "04-resume/model-ir.json",
        "04-resume/reference-assembly-receipt.json",
        "04-resume/reference-checkpoint.mlpcp",
        "04-resume/reference-checkpoint.pcgcp",
        "04-resume/reference-reaction-ir.json",
        "04-resume/reference-recovery-ir.json",
        "04-resume/reference-result-ir.json",
        "04-resume/report-ir.json",
        "04-resume/report.md",
        "04-resume/result-ir.json",
        "04-resume/run-receipt.json",
        "06-report/buckling-result-view.en-US.txt",
        "06-report/buckling-result-view.ko-KR.txt",
        "06-report/report-receipt.json",
        "workbench-session.json",
    ];
    let root = resolve_workspace_child(workspace, root, label)?;
    ...
    if paths != expected {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_inventory_invalid",
            format!("{label} does not contain the exact durable buckling Workbench inventory"),
        ));
    }
    paths
        .into_iter()
...
#[allow(clippy::too_many_lines)]
fn inspect_rootfs_model_buckling_workbench_surface(
    workspace: &Path,
    request: &RootfsIsolationProbeRequest<'_>,
) -> Result<ModelBucklingWorkbenchSurfaceSummary, DistributionError> {
    ...
    let restarted = inspect_buckling_workbench_tree(
        workspace,
        request.model_buckling_workbench_restarted_root,
        "restarted durable buckling Workbench",
    )?;
    let direct = inspect_buckling_workbench_tree(
        workspace,
        request.model_buckling_workbench_direct_root,
        "one-shot durable buckling Workbench",
    )?;
    if restarted != direct {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_restart_mismatch",
            "staged/restarted and one-shot durable buckling Workbench trees differ",
        ));
    }
    for name in PRODUCT_FILES {
            ...
            != modal_workbench_tree_file(&direct, &format!("04-resume/{name}"))?
        {
            return Err(DistributionError::new(
                "rootfs_model_buckling_workbench_restart_mismatch",
                format!("durable buckling Workbench direct/resume artifact differs: {name}"),
            ));
        }
    }
    let cli_product = inspect_exact_modal_directory(
        ...
        request.model_buckling_direct_root,
        &PRODUCT_FILES,
        "CLI buckling product for durable Workbench comparison",
    )?;
    for (index, name) in PRODUCT_FILES.iter().enumerate() {
        if cli_product[index] != modal_workbench_tree_file(&direct, &format!("04-resume/{name}"))? {
            return Err(DistributionError::new(
                "rootfs_model_buckling_workbench_product_mismatch",
                format!("durable Workbench and installed CLI buckling product differ: {name}"),
            ));
        }
    }

    let session_bytes = modal_workbench_tree_file(&direct, "workbench-session.json")?;
    let session = parse_modal_workbench_json(session_bytes, "session_hash", "buckling session")?;
    let validation_bytes =
        modal_workbench_tree_file(&direct, "02-validate/validation-receipt.json")?;
    let validation = parse_modal_workbench_json(
        validation_bytes,
        "receipt_hash",
        "buckling validation receipt",
    )?;
    let report_bytes = modal_workbench_tree_file(&direct, "06-report/report-receipt.json")?;
    let report =
        parse_modal_workbench_json(report_bytes, "receipt_hash", "buckling report receipt")?;
    if session
        .get("schema_version")
        .and_then(serde_json::Value::as_str)
        != Some("structural-native-model-ir-linear-buckling-workbench-session.v1")
        || session.get("stage").and_then(serde_json::Value::as_str) != Some("reported")
        || validation
            .get("schema_version")
            .and_then(serde_json::Value::as_str)
            != Some("structural-native-model-ir-linear-buckling-workbench-validation-receipt.v1")
        || report
            .get("schema_version")
            .and_then(serde_json::Value::as_str)
            != Some("structural-native-model-ir-linear-buckling-workbench-report-receipt.v1")
        || !report
            .get("external_comparison")
            .is_some_and(serde_json::Value::is_null)
        || !report
    ...
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_contract_invalid",
            "durable buckling Workbench session/validation/report contract is invalid",
        ));
    }

    let reconciled_bytes = read_direct_workspace_file(
        workspace,
        request.model_buckling_workbench_reconciled_stdout,
        "buckling crash-reconciliation output",
    )?;
    let reconciled = parse_modal_workbench_json(
        &reconciled_bytes,
        "session_hash",
    ...
    if reconciled.get("stage").and_then(serde_json::Value::as_str) != Some("direct") {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_reconciliation_invalid",
            "buckling status did not expose the reconciled direct stage",
        ));
    }
    let inspect_first = read_direct_workspace_file(
        workspace,
        request.model_buckling_workbench_inspect_first,
        "first buckling Workbench inspect",
    )?;
    let inspect_second = read_direct_workspace_file(
        workspace,
        request.model_buckling_workbench_inspect_second,
        "second buckling Workbench inspect",
    )?;
    if inspect_first != inspect_second {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_inspect_mismatch",
            "repeated buckling Workbench inspect output differs",
        ));
    }
    let inspect = parse_modal_workbench_json(&inspect_first, "view_hash", "buckling inspect")?;
    if inspect
        .get("durable_stage")
        .and_then(serde_json::Value::as_str)
        != Some("reported")
    ...
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_inspect_invalid",
            "buckling Workbench inspect does not match the terminal null-authority contract",
        ));
    }
    let tamper_bytes = read_direct_workspace_file(
        workspace,
        request.model_buckling_workbench_tamper_failure,
        "buckling Workbench tamper failure",
    )?;
    let tamper = structural_contracts::model_ir::decode_json_strict(
        tamper_bytes.strip_suffix(b"\n").unwrap_or(&tamper_bytes),
    )
    .map_err(|error| {
        DistributionError::new(
            "rootfs_model_buckling_workbench_tamper_invalid",
            format!("buckling Workbench tamper failure is invalid JSON: {error}"),
        )
    })?;
    if tamper
        .get("schema_version")
        ...
        != Some("structural-native-workbench-failure.v1")
        || tamper.get("code").and_then(serde_json::Value::as_str)
            != Some("workbench_buckling_result_view_receipt_mismatch")
    {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_tamper_invalid",
            "buckling Workbench checkpoint mutation did not fail closed with the exact taxonomy",
        ));
    }
    let identities = [
        sha256_identity(session_bytes),
    ...
    if identities.iter().collect::<BTreeSet<_>>().len() != identities.len() {
        return Err(DistributionError::new(
            "rootfs_model_buckling_workbench_identity_collision",
            "durable buckling Workbench evidence identities collide",
        ));
    }
    Ok(ModelBucklingWorkbenchSurfaceSummary {
        session_sha256: identities[0].clone(),
        validation_receipt_sha256: identities[1].clone(),
        report_receipt_sha256: identities[2].clone(),
        inspect_sha256: identities[3].clone(),
...
#[cfg(test)]
fn seal_rootfs_isolation_evidence_v16(
    evidence: RootfsIsolationEvidenceV16,
) -> Result<RootfsIsolationReceiptV16, DistributionError> {
    let receipt_hash = sha256_identity(&canonical_json(&evidence)?);
    Ok(RootfsIsolationReceiptV16 {
        schema_version: ROOTFS_RECEIPT_SCHEMA_VERSION_V16.to_owned(),
        evidence,
        receipt_hash,
    })
}
...
#[cfg(test)]
fn seal_rootfs_isolation_evidence_v19(
    evidence: RootfsIsolationEvidenceV19,
) -> Result<RootfsIsolationReceiptV19, DistributionError> {
    let receipt_hash = sha256_identity(&canonical_json(&evidence)?);
    Ok(RootfsIsolationReceiptV19 {
        schema_version: ROOTFS_RECEIPT_SCHEMA_VERSION_V19.to_owned(),
        evidence,
        receipt_hash,
    })
}
...
fn validate_rootfs_isolation_evidence_v15(
    ...
    if evidence
        ...
        .prior
        .claim_boundary
        != ROOTFS_RECEIPT_CLAIM_BOUNDARY_V15
...
fn validate_rootfs_isolation_evidence_v16(
    evidence: &RootfsIsolationEvidenceV16,
) -> Result<(), DistributionError> {
    let identities = [
        evidence.model_ir_frame3d_end_release_model_sha256.as_str(),
        evidence
    ...
    if evidence
        ...
        .prior
        .claim_boundary
        != ROOTFS_RECEIPT_CLAIM_BOUNDARY_V16
        || !evidence.model_ir_frame3d_end_release_linear_cpu_surface_passed
        || !evidence.model_ir_frame3d_end_release_linear_cpu_restart_bitwise_passed
        || evidence.model_ir_frame3d_end_release_linear_cpu_fallback_count != 0
        || !evidence.model_ir_frame3d_end_release_released_force_exact_zero_passed
        || identities.len() != 5
    {
        return Err(DistributionError::new(
            "rootfs_receipt_contract_invalid",
            "rootfs v16 receipt weakens or exceeds the exact Frame3D end-release linear CPU diagnostic contract",
        ));
    }
    for (value, label) in [
        (
            &evidence.model_ir_frame3d_end_release_model_sha256,
            "rootfs Frame3D end-release model SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_end_release_request_sha256,
            "rootfs Frame3D end-release request SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_end_release_result_ir_sha256,
            "rootfs Frame3D end-release ResultIR SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_end_release_recovery_sha256,
            "rootfs Frame3D end-release recovery SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_end_release_checkpoint_sha256,
            "rootfs Frame3D end-release checkpoint SHA-256",
        ),
    ] {
        validate_sha256_identity(value, label)?;
    }
    ...
    validate_rootfs_isolation_evidence_v15(&prior)
}

fn validate_rootfs_isolation_evidence_v17(
    evidence: &RootfsIsolationEvidenceV17,
) -> Result<(), DistributionError> {
    let identities = [
        evidence.model_ir_self_weight_model_sha256.as_str(),
        evidence.model_ir_self_weight_request_sha256.as_str(),
        evidence.model_ir_self_weight_result_ir_sha256.as_str(),
        evidence.model_ir_self_weight_recovery_sha256.as_str(),
        evidence.model_ir_self_weight_reaction_sha256.as_str(),
        evidence.model_ir_self_weight_checkpoint_sha256.as_str(),
    ]
    .into_iter()
    .collect::<BTreeSet<_>>();
    if evidence
        ...
        || !evidence.model_ir_self_weight_standard_gravity_passed
        || !evidence.model_ir_self_weight_closed_form_tip_displacement_passed
        || identities.len() != 6
    {
        return Err(DistributionError::new(
            "rootfs_receipt_contract_invalid",
            "rootfs v17 receipt weakens or exceeds the exact Frame3D self-weight linear CPU diagnostic contract",
        ));
    }
    for (value, label) in [
        (
            &evidence.model_ir_self_weight_model_sha256,
            "rootfs Frame3D self-weight model SHA-256",
        ),
        (
            &evidence.model_ir_self_weight_request_sha256,
            "rootfs Frame3D self-weight request SHA-256",
        ),
        (
            &evidence.model_ir_self_weight_result_ir_sha256,
            "rootfs Frame3D self-weight ResultIR SHA-256",
        ),
        (
            &evidence.model_ir_self_weight_recovery_sha256,
            "rootfs Frame3D self-weight recovery SHA-256",
        ),
        (
            &evidence.model_ir_self_weight_reaction_sha256,
            "rootfs Frame3D self-weight reaction SHA-256",
        ),
        (
            &evidence.model_ir_self_weight_checkpoint_sha256,
            "rootfs Frame3D self-weight checkpoint SHA-256",
        ),
    ] {
        validate_sha256_identity(value, label)?;
    }
...
fn validate_rootfs_isolation_evidence_v18(
    ...
    if evidence
        ...
        .prior
        .claim_boundary
        != ROOTFS_RECEIPT_CLAIM_BOUNDARY_V18
...
#[allow(clippy::too_many_lines)]
fn validate_rootfs_isolation_evidence_v19(
    evidence: &RootfsIsolationEvidenceV19,
) -> Result<(), DistributionError> {
    let identities = [
        evidence
    ...
    if evidence
        ...
        .prior
        .claim_boundary
        != ROOTFS_RECEIPT_CLAIM_BOUNDARY_V19
        || !evidence.model_ir_frame3d_prescribed_support_linear_cpu_surface_passed
        || !evidence.model_ir_frame3d_prescribed_support_linear_cpu_restart_bitwise_passed
        || evidence.model_ir_frame3d_prescribed_support_linear_cpu_fallback_count != 0
        || !evidence.model_ir_frame3d_prescribed_support_effective_rhs_passed
        || !evidence.model_ir_frame3d_prescribed_support_terminal_displacement_passed
        || !evidence.model_ir_frame3d_prescribed_support_reaction_passed
        || identities.len() != 8
    {
        return Err(DistributionError::new(
            "rootfs_receipt_contract_invalid",
            "rootfs v19 receipt weakens or exceeds the exact Frame3D prescribed support linear CPU diagnostic contract",
        ));
    }
    for (value, label) in [
        (
            &evidence.model_ir_frame3d_prescribed_support_model_sha256,
            "rootfs Frame3D prescribed support model SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_edit_receipt_sha256,
            "rootfs Frame3D prescribed support edit receipt SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_combination_receipt_sha256,
            "rootfs Frame3D prescribed support combination receipt SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_request_sha256,
            "rootfs Frame3D prescribed support request SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_result_ir_sha256,
            "rootfs Frame3D prescribed support ResultIR SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_recovery_sha256,
            "rootfs Frame3D prescribed support recovery SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_reaction_sha256,
            "rootfs Frame3D prescribed support reaction SHA-256",
        ),
        (
            &evidence.model_ir_frame3d_prescribed_support_checkpoint_sha256,
            "rootfs Frame3D prescribed support checkpoint SHA-256",
        ),
    ] {
        validate_sha256_identity(value, label)?;
    }
    ...
    validate_rootfs_isolation_evidence_v18(&prior)
}

#[allow(clippy::too_many_lines)]
fn validate_rootfs_isolation_evidence_v20(
    evidence: &RootfsIsolationEvidenceV20,
) -> Result<(), DistributionError> {
    let identities = [
        evidence.model_ir_buckling_model_sha256.as_str(),
        evidence.model_ir_buckling_request_sha256.as_str(),
        evidence
            .workbench_model_buckling_request_receipt_sha256
            .as_str(),
        evidence.model_ir_buckling_checkpoint_sha256.as_str(),
        evidence.model_ir_buckling_result_ir_sha256.as_str(),
        evidence.model_ir_buckling_run_receipt_sha256.as_str(),
        evidence
    ...
    if evidence
        ...
        || !evidence.model_ir_buckling_restart_bitwise_passed
        || !evidence.workbench_model_buckling_result_view_surface_passed
        || !evidence.workbench_model_buckling_result_view_read_only_passed
        || !evidence.workbench_model_buckling_result_view_invalid_window_rejected
        || !evidence.workbench_model_buckling_durable_session_surface_passed
        || !evidence.workbench_model_buckling_durable_session_crash_reconciliation_passed
        || !evidence.workbench_model_buckling_durable_session_restart_bitwise_passed
        || !evidence.workbench_model_buckling_durable_session_tamper_rejected
        || !evidence.workbench_model_buckling_durable_session_null_authority_passed
        || evidence.model_ir_buckling_mode_count != 2
        || evidence.model_ir_buckling_active_dof_count != 6
        || evidence.model_ir_buckling_fallback_count != 0
        || identities.len() != 12
    {
        return Err(DistributionError::new(
            "rootfs_receipt_contract_invalid",
            "rootfs v20 receipt weakens or exceeds the exact installed linear-buckling diagnostic contract",
        ));
    }
    for (value, label) in [
        (
            &evidence.model_ir_buckling_model_sha256,
            "rootfs buckling model SHA-256",
        ),
        (
            &evidence.model_ir_buckling_request_sha256,
            "rootfs buckling request SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_request_receipt_sha256,
            "rootfs buckling request receipt SHA-256",
        ),
        (
            &evidence.model_ir_buckling_checkpoint_sha256,
            "rootfs buckling checkpoint SHA-256",
        ),
        (
            &evidence.model_ir_buckling_result_ir_sha256,
            "rootfs buckling ResultIR SHA-256",
        ),
        (
            &evidence.model_ir_buckling_run_receipt_sha256,
            "rootfs buckling run receipt SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_result_view_en_us_sha256,
            "rootfs buckling en-US view SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_result_view_ko_kr_sha256,
            "rootfs buckling ko-KR view SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_durable_session_sha256,
            "rootfs buckling durable session SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_durable_validation_receipt_sha256,
            "rootfs buckling durable validation receipt SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_durable_report_receipt_sha256,
            "rootfs buckling durable report receipt SHA-256",
        ),
        (
            &evidence.workbench_model_buckling_durable_inspect_sha256,
            "rootfs buckling durable inspect SHA-256",
        ),
    ] {
        validate_sha256_identity(value, label)?;
    }
...
mod tests {
    ...
    fn rootfs_evidence_v16() -> RootfsIsolationEvidenceV16 {
        let mut prior = rootfs_evidence_v15();
        ROOTFS_RECEIPT_CLAIM_BOUNDARY_V16.clone_into(
            &mut prior
                .prior
                .prior
        ...
        let identity = |value: u8| format!("sha256:{value:064x}");
        RootfsIsolationEvidenceV16 {
            prior,
            model_ir_frame3d_end_release_linear_cpu_surface_passed: true,
            model_ir_frame3d_end_release_linear_cpu_restart_bitwise_passed: true,
            model_ir_frame3d_end_release_linear_cpu_fallback_count: 0,
            model_ir_frame3d_end_release_released_force_exact_zero_passed: true,
            model_ir_frame3d_end_release_model_sha256: identity(92),
            model_ir_frame3d_end_release_request_sha256: identity(93),
            model_ir_frame3d_end_release_result_ir_sha256: identity(94),
            model_ir_frame3d_end_release_recovery_sha256: identity(95),
            model_ir_frame3d_end_release_checkpoint_sha256: identity(96),
        }
    }
    ...
    fn rootfs_evidence_v17() -> RootfsIsolationEvidenceV17 {
        ...
        RootfsIsolationEvidenceV17 {
            ...
            model_ir_self_weight_standard_gravity_passed: true,
            model_ir_self_weight_closed_form_tip_displacement_passed: true,
            model_ir_self_weight_model_sha256: identity(97),
            model_ir_self_weight_request_sha256: identity(98),
            model_ir_self_weight_result_ir_sha256: identity(99),
    ...
    fn rootfs_evidence_v19() -> RootfsIsolationEvidenceV19 {
        let mut prior = rootfs_evidence_v18();
        ROOTFS_RECEIPT_CLAIM_BOUNDARY_V19.clone_into(
            &mut prior
                .prior
                .prior
        ...
        RootfsIsolationEvidenceV19 {
            ...
            model_ir_frame3d_prescribed_support_terminal_displacement_passed: true,
            model_ir_frame3d_prescribed_support_reaction_passed: true,
            model_ir_frame3d_prescribed_support_model_sha256: identity(109),
            model_ir_frame3d_prescribed_support_edit_receipt_sha256: identity(110),
            model_ir_frame3d_prescribed_support_combination_receipt_sha256: identity(111),
            model_ir_frame3d_prescribed_support_request_sha256: identity(112),
            model_ir_frame3d_prescribed_support_result_ir_sha256: identity(113),
            model_ir_frame3d_prescribed_support_recovery_sha256: identity(114),
            model_ir_frame3d_prescribed_support_reaction_sha256: identity(115),
            model_ir_frame3d_prescribed_support_checkpoint_sha256: identity(116),
        }
    }
    ...
    fn rootfs_evidence_v20() -> RootfsIsolationEvidenceV20 {
        ...
        RootfsIsolationEvidenceV20 {
            ...
            model_ir_buckling_active_dof_count: 6,
            model_ir_buckling_fallback_count: 0,
            model_ir_buckling_model_sha256: identity(117),
            model_ir_buckling_request_sha256: identity(118),
            workbench_model_buckling_request_receipt_sha256: identity(119),
            model_ir_buckling_checkpoint_sha256: identity(120),
            model_ir_buckling_result_ir_sha256: identity(121),
            model_ir_buckling_run_receipt_sha256: identity(122),
            workbench_model_buckling_result_view_en_us_sha256: identity(123),
            workbench_model_buckling_result_view_ko_kr_sha256: identity(124),
            workbench_model_buckling_durable_session_sha256: identity(125),
    ...
    #[test]
    fn frozen_rootfs_v15_receipt_remains_bundle_verifiable_and_fail_closed() {
        ...
        let receipt =
            seal_rootfs_isolation_evidence_v15(evidence.clone()).expect("seal v15 evidence");
    ...
    #[test]
    fn frozen_rootfs_v16_receipt_remains_bundle_verifiable_and_fail_closed() {
        let temporary = TestDirectory::create("rootfs-v16-receipt");
        let bundle = make_bundle(&temporary, "rootfs-v16-release", "v16");
        let manifest = verify_bundle(&bundle).expect("verify v16 fixture bundle");
        let mut evidence = rootfs_evidence_v16();
        bind_rootfs_evidence_to_bundle(
            &mut evidence
                .prior
                .prior
        ...
        evidence.prior.prior.prior.structural_cli_sha256 =
            sha256_file(&bundle.join("payload/bin/structural-cli")).expect("hash fixture CLI");
        validate_rootfs_isolation_evidence_v16(&evidence).expect("validate current v16 evidence");
        let receipt =
            seal_rootfs_isolation_evidence_v16(evidence.clone()).expect("seal v16 evidence");
        let receipt_path = temporary.0.join("rootfs-v16-receipt.json");
        fs::write(
            &receipt_path,
            canonical_json(&receipt).expect("canonical v16 receipt"),
        )
        .expect("write current v16 receipt");
        assert!(matches!(
            verify_rootfs_isolation_receipt(&receipt_path, &bundle)
                .expect("verify current v16 receipt against its bundle"),
            VerifiedRootfsIsolationReceipt::V16(_)
        ));

        let mut weakened = evidence.clone();
        weakened.model_ir_frame3d_end_release_released_force_exact_zero_passed = false;
        weakened.model_ir_frame3d_end_release_linear_cpu_fallback_count = 1;
        assert_eq!(
            validate_rootfs_isolation_evidence_v16(&weakened)
                .expect_err("weakened Frame3D end-release evidence must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );

        let mut colliding = evidence;
        colliding.model_ir_frame3d_end_release_recovery_sha256 = colliding
            .model_ir_frame3d_end_release_result_ir_sha256
            .clone();
        assert_eq!(
            validate_rootfs_isolation_evidence_v16(&colliding)
                .expect_err("colliding Frame3D end-release identities must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );
    }
    ...
    #[test]
    fn current_rootfs_v17_receipt_is_bundle_verifiable_and_fail_closed() {
        let temporary = TestDirectory::create("rootfs-v17-receipt");
        let bundle = make_bundle(&temporary, "rootfs-v17-release", "v17");
        let manifest = verify_bundle(&bundle).expect("verify v17 fixture bundle");
        let mut evidence = rootfs_evidence_v17();
        bind_rootfs_evidence_to_bundle(
            &mut evidence
                .prior
                .prior
        ...
        fs::write(
            &receipt_path,
            canonical_json(&receipt).expect("canonical v17 receipt"),
        )
        .expect("write current v17 receipt");
        assert!(matches!(
            verify_rootfs_isolation_receipt(&receipt_path, &bundle)
                .expect("verify current v17 receipt against its bundle"),
            VerifiedRootfsIsolationReceipt::V17(_)
        ));

        let mut weakened = evidence.clone();
        weakened.model_ir_self_weight_standard_gravity_passed = false;
        weakened.model_ir_self_weight_linear_cpu_fallback_count = 1;
        assert_eq!(
            validate_rootfs_isolation_evidence_v17(&weakened)
                .expect_err("weakened Frame3D self-weight evidence must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );

        let mut colliding = evidence;
        colliding.model_ir_self_weight_reaction_sha256 =
            colliding.model_ir_self_weight_result_ir_sha256.clone();
        assert_eq!(
    ...
    #[test]
    fn frozen_rootfs_v18_receipt_remains_bundle_verifiable_and_fail_closed() {
        ...
        let receipt =
            seal_rootfs_isolation_evidence_v18(evidence.clone()).expect("seal v18 evidence");
    ...
    #[test]
    fn current_rootfs_v19_receipt_is_bundle_verifiable_and_fail_closed() {
        let temporary = TestDirectory::create("rootfs-v19-receipt");
        let bundle = make_bundle(&temporary, "rootfs-v19-release", "v19");
        let manifest = verify_bundle(&bundle).expect("verify v19 fixture bundle");
        let mut evidence = rootfs_evidence_v19();
        bind_rootfs_evidence_to_bundle(
            &mut evidence
                .prior
                .prior
        ...
        evidence
            ...
            .structural_cli_sha256 =
            sha256_file(&bundle.join("payload/bin/structural-cli")).expect("hash fixture CLI");
        validate_rootfs_isolation_evidence_v19(&evidence).expect("validate current v19 evidence");
        let receipt =
            seal_rootfs_isolation_evidence_v19(evidence.clone()).expect("seal v19 evidence");
        let receipt_path = temporary.0.join("rootfs-v19-receipt.json");
        fs::write(
            &receipt_path,
            canonical_json(&receipt).expect("canonical v19 receipt"),
        )
        .expect("write current v19 receipt");
        assert!(matches!(
            verify_rootfs_isolation_receipt(&receipt_path, &bundle)
                .expect("verify current v19 receipt against its bundle"),
            VerifiedRootfsIsolationReceipt::V19(_)
        ));

        let mut weakened = evidence.clone();
        weakened.model_ir_frame3d_prescribed_support_effective_rhs_passed = false;
        weakened.model_ir_frame3d_prescribed_support_linear_cpu_fallback_count = 1;
        assert_eq!(
            validate_rootfs_isolation_evidence_v19(&weakened)
                .expect_err("weakened Frame3D prescribed support evidence must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );

        let mut colliding = evidence;
        colliding.model_ir_frame3d_prescribed_support_reaction_sha256 = colliding
            .model_ir_frame3d_prescribed_support_result_ir_sha256
            .clone();
        assert_eq!(
            validate_rootfs_isolation_evidence_v19(&colliding)
                .expect_err("colliding Frame3D prescribed support identities must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );
    }
    ...
    fn frozen_rootfs_v20_receipt_remains_bundle_verifiable_and_fail_closed() {
        ...
        let mut evidence = rootfs_evidence_v20();
        bind_rootfs_evidence_to_bundle(
            &mut evidence
                .prior
                .prior
        ...
        fs::write(
            &receipt_path,
            canonical_json(&receipt).expect("canonical v20 receipt"),
        )
        .expect("write current v20 receipt");
        assert!(matches!(
            verify_rootfs_isolation_receipt(&receipt_path, &bundle)
                .expect("verify current v20 receipt against its bundle"),
            VerifiedRootfsIsolationReceipt::V20(_)
        ));

        let mut weakened = evidence.clone();
        weakened.model_ir_buckling_mode_count = 1;
        weakened.workbench_model_buckling_durable_session_tamper_rejected = false;
        assert_eq!(
            validate_rootfs_isolation_evidence_v20(&weakened)
                .expect_err("weakened buckling evidence must fail closed")
                .code,
            "rootfs_receipt_contract_invalid"
        );

        let mut colliding = evidence;
        colliding.workbench_model_buckling_durable_report_receipt_sha256 =
            colliding.model_ir_buckling_result_ir_sha256.clone();
        assert_eq!(
