...
mod model_ir_linear_buckling;
pub use model_ir_linear_buckling::*;
...
pub const SA_ABI_V1_CURRENT: u32 = SA_ABI_V1_15;
...
pub struct SaApiV1 {
    ...
    pub model_ir_linear_buckling_assemble: Option<SaModelIrLinearBucklingAssembleFnV1>,
}
...
impl Default for SaApiV1 {
    fn default() -> Self {
        Self {
            ...
            model_ir_linear_buckling_assemble: None,
        }
    }
}
...
mod tests {
    ...
    fn rust_layout_matches_the_public_c_header_contract() {
        ...
        assert_eq!(offset_of!(SaApiV1, model_ir_linear_buckling_assemble), 216);
