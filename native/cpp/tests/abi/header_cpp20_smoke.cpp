...
static_assert(std::is_standard_layout_v<sa_model_ir_linear_assembly_sizes_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_assembly_config_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_assembly_outputs_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_assembly_result_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_reaction_sizes_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_reaction_config_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_reaction_outputs_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_reaction_result_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_buckling_assembly_config_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_buckling_assembly_outputs_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_linear_buckling_assembly_result_v1>);
...
static_assert(std::is_standard_layout_v<sa_backend_request_v1>);
static_assert(std::is_standard_layout_v<sa_full_residual_operator_v1>);
static_assert(std::is_standard_layout_v<sa_full_residual_eval_config_v1>);
static_assert(std::is_standard_layout_v<sa_full_residual_status_v1>);
static_assert(std::is_standard_layout_v<sa_backend_api_v1>);
static_assert(std::is_standard_layout_v<sa_model_ir_descriptor_v1>);
static_assert(SA_MODEL_IR_LINEAR_MAX_GLOBAL_DOF_COUNT == UINT64_C(1000000));
static_assert(SA_MODEL_IR_LINEAR_MAX_STRUCTURAL_ENTRIES == UINT64_C(100000000));
static_assert(SA_MODEL_IR_LINEAR_MAX_RECOVERY_RECORD_COUNT == UINT64_C(1000000));
static_assert(SA_MODEL_IR_LINEAR_MAX_DIRECT_COMBINATION_TERMS == UINT64_C(64));
static_assert(SA_MODEL_IR_LINEAR_MAX_NESTED_COMBINATION_DEPTH == UINT64_C(8));
static_assert(SA_MODEL_IR_LINEAR_MAX_EXPANDED_COMBINATION_TERMS == UINT64_C(64));
static_assert(sizeof(sa_api_v1) == 224U);
static_assert(SA_API_V1_13_MIN_SIZE == 200U);
static_assert(SA_API_V1_14_MIN_SIZE == 216U);
static_assert(SA_API_V1_15_MIN_SIZE == 224U);
...
static_assert(sizeof(sa_member_distributed_load_descriptor_v1) == 144U);
static_assert(sizeof(sa_model_ir_descriptor_v1) == 624U);
static_assert(offsetof(sa_model_ir_descriptor_v1, member_distributed_loads) == 608U);
