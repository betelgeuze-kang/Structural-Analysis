...
/// `load_pattern_id` selector accepts one pattern, one bounded two-to-64-term direct linear
/// combination, or one acyclic nested combination with depth/expansion bounds; ambiguous and
/// out-of-bound selectors fail closed.
