...
def test_engine_v2_core_source_inventory_is_explicit_and_backend_neutral() -> None:
    ...
    assert relative_sources == {
        ...
        "src/structural_analysis/engine_v2/contracts/contact_static_result.py",
        ...
        "src/structural_analysis/engine_v2/contracts/mdof_transient_result.py",
        ...
        "src/structural_analysis/engine_v2/contracts/shell_static_result.py",
