...
def test_fixed_rank_coarse_public_surface_is_unique_and_identity_preserving() -> None:
    ...
    for module in (coarse_plan_v1, coarse_rtc_v1):
...
def test_fixed_rank_coarse_schema_and_kernel_source_are_packaged() -> None:
    schema = (
        ...
        .joinpath("hip_fgmres_fixed_rank_coarse_plan_v1.schema.json")
    ...
    assert "hip-fgmres-fixed-rank-coarse-plan.v1" in schema
