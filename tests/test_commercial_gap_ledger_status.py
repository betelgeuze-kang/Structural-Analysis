...
def test_commercial_gap_ledger_status_is_honest_about_current_blockers() -> None:
    ...
    assert "child_relative_increment_gate_not_proven" in full_load_terminal[
        "non_closing_reasons"
    ]
    ...
    assert "rocm_hip_runtime_unavailable" in hip_terminal["observed"][
        "receipt_blockers"
    ]
    assert (
    ...
    assert "consistent_residual_jacobian_newton_gate_not_passed" in hip_terminal[
        "observed"
    ...
    direct_followup56_replay = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_external_checkpoint_replay"
    ]
    assert direct_followup56_replay["status"] == "partial"
    assert direct_followup56_replay["ready"] is False
    assert direct_followup56_replay["base_direct_residual_inf_n"] == 5471.309240222771
    assert (
        direct_followup56_replay["final_direct_residual_inf_n"]
        == direct_followup56_replay["base_direct_residual_inf_n"]
    )
    direct_followup56_largest_rows = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_rowcorr_largest_rows_support4"
    ]
    assert direct_followup56_largest_rows["status"] == "partial"
    assert (
        direct_followup56_largest_rows["base_direct_residual_inf_n"]
        == direct_followup56_replay["base_direct_residual_inf_n"]
    )
    assert (
    ...
    assert (
        direct_followup56_largest_rows[
            "current_tangent_residual_row_correction_accepted"
        ]
        is True
    )
    assert direct_followup56_largest_rows["output_final_checkpoint_written"] is True
    direct_followup56_largest_rows_followup2 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_rowcorr_largest_rows_support4_followup2"
    ]
    assert (
        direct_followup56_largest_rows_followup2["base_direct_residual_inf_n"]
        == direct_followup56_largest_rows["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_largest_rows_followup2["final_direct_residual_inf_n"]
        == direct_followup56_largest_rows["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_largest_rows_followup2[
            "current_tangent_residual_row_correction_accepted"
        ]
        is False
    )
    ...
    assert (
        direct_followup56_largest_rows_followup2["output_final_checkpoint_written"]
        is False
    )
    direct_followup56_largest_rows_support8 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_rowcorr_largest_rows_support8"
    ]
    assert (
        direct_followup56_largest_rows_support8["base_direct_residual_inf_n"]
        == direct_followup56_largest_rows["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_largest_rows_support8["final_direct_residual_inf_n"]
        == direct_followup56_largest_rows["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_largest_rows_support8[
            "current_tangent_residual_row_correction_accepted"
        ]
        is False
    )
    ...
    assert (
        direct_followup56_largest_rows_support8["best_candidate_support_column_count"]
        == 8
    )
    direct_followup56_directional_timeout = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_rowcorr_largest_rows_support4_directional_timeout"
    ]
    assert direct_followup56_directional_timeout["status"] == "timeout"
    assert (
        direct_followup56_directional_timeout["source_checkpoint_direct_residual_inf_n"]
        == direct_followup56_largest_rows["final_direct_residual_inf_n"]
    )
    assert (
    ...
    direct_post_frame_translation_block_lstsq = rows["G1"]["evidence"][
        "direct_residual_post_frame_block_lstsq_translation_support32"
    ]
    assert (
        direct_post_frame_translation_block_lstsq["base_direct_residual_inf_n"]
        == direct_followup56_frame_block_lstsq["final_direct_residual_inf_n"]
    )
    assert (
        direct_post_frame_translation_block_lstsq["final_direct_residual_inf_n"]
        == direct_followup56_frame_block_lstsq["final_direct_residual_inf_n"]
    )
    assert direct_post_frame_translation_block_lstsq["promotion_count"] == 0
    assert (
        direct_post_frame_translation_block_lstsq["stop_reason"]
        == "max_wall_seconds_exceeded"
    )
    assert (
        direct_post_frame_translation_block_lstsq[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "translation"
    )
    assert direct_post_frame_translation_block_lstsq[
        "frame_hotspot_block_lstsq_support_size"
    ] == 332
    assert (
        direct_post_frame_translation_block_lstsq["output_final_checkpoint_path"]
        is None
    )
    direct_followup56_frame_support64 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_post_rowcorr_block_lstsq_frame_support64"
    ]
    assert (
        direct_followup56_frame_support64["base_direct_residual_inf_n"]
        == direct_followup56_frame_block_lstsq["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_frame_support64["final_direct_residual_inf_n"]
        == 5379.124335653743
    )
    assert direct_followup56_frame_support64["promotion_count"] == 1
    assert direct_followup56_frame_support64["max_promotions"] == 2
    assert direct_followup56_frame_support64["stop_reason"] == "max_wall_seconds_exceeded"
    assert (
        direct_followup56_frame_support64[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "frame"
    )
    assert direct_followup56_frame_support64[
        "frame_hotspot_block_lstsq_support_size"
    ] == 286
    assert (
        direct_followup56_frame_support64["output_final_checkpoint_path"]
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_frame_frontier_post_followup56_rowcorr_support64_probe_final_checkpoint.npz"
    )
    direct_followup56_frame_support64_followup2 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_post_rowcorr_block_lstsq_frame_support64_followup2"
    ]
    assert (
        direct_followup56_frame_support64_followup2["base_direct_residual_inf_n"]
        == direct_followup56_frame_support64["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_frame_support64_followup2["final_direct_residual_inf_n"]
        == 5349.008589697558
    )
    assert direct_followup56_frame_support64_followup2["promotion_count"] == 1
    assert (
        direct_followup56_frame_support64_followup2["stop_reason"]
        == "progress_artifact_after_accepted_pass"
    )
    assert (
        direct_followup56_frame_support64_followup2[
            "frame_hotspot_block_lstsq_support_size"
        ]
        is None
    )
    assert (
        direct_followup56_frame_support64_followup2["output_final_checkpoint_path"]
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_frame_frontier_post_followup56_rowcorr_support64_followup2_probe_final_checkpoint.npz"
    )
    direct_followup56_frame_support64_followup3 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_post_rowcorr_block_lstsq_frame_support64_followup3"
    ]
    assert (
        direct_followup56_frame_support64_followup3["base_direct_residual_inf_n"]
        == direct_followup56_frame_support64_followup2["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_frame_support64_followup3["final_direct_residual_inf_n"]
        == 5317.375945954874
    )
    assert direct_followup56_frame_support64_followup3["promotion_count"] == 1
    assert direct_followup56_frame_support64_followup3["max_promotions"] == 1
    assert (
        direct_followup56_frame_support64_followup3["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_followup56_frame_support64_followup3[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "frame"
    )
    assert direct_followup56_frame_support64_followup3[
        "frame_hotspot_block_lstsq_support_size"
    ] == 285
    assert (
        direct_followup56_frame_support64_followup3["output_final_checkpoint_path"]
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_frame_frontier_post_followup56_rowcorr_support64_followup3_probe_final_checkpoint.npz"
    )
    direct_followup56_frame_support64_followup4 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_post_rowcorr_block_lstsq_frame_support64_followup4"
    ]
    assert (
        direct_followup56_frame_support64_followup4["base_direct_residual_inf_n"]
        == direct_followup56_frame_support64_followup3["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_frame_support64_followup4["final_direct_residual_inf_n"]
        == 5288.717597743145
    )
    assert direct_followup56_frame_support64_followup4["promotion_count"] == 1
    assert direct_followup56_frame_support64_followup4["max_promotions"] == 1
    assert (
        direct_followup56_frame_support64_followup4["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_followup56_frame_support64_followup4[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "frame"
    )
    assert direct_followup56_frame_support64_followup4[
        "frame_hotspot_block_lstsq_support_size"
    ] == 282
    assert (
        direct_followup56_frame_support64_followup4["output_final_checkpoint_path"]
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_frame_frontier_post_followup56_rowcorr_support64_followup4_probe_final_checkpoint.npz"
    )
    direct_followup56_frame_support64_followup5 = rows["G1"]["evidence"][
        "direct_residual_newton_followup56_post_rowcorr_block_lstsq_frame_support64_followup5"
    ]
    assert (
        direct_followup56_frame_support64_followup5["base_direct_residual_inf_n"]
        == direct_followup56_frame_support64_followup4["final_direct_residual_inf_n"]
    )
    assert (
        direct_followup56_frame_support64_followup5["final_direct_residual_inf_n"]
        == direct_followup56_frame_support64_followup4["final_direct_residual_inf_n"]
    )
    assert direct_followup56_frame_support64_followup5["promotion_count"] == 0
    assert (
        direct_followup56_frame_support64_followup5["stop_reason"]
        == "no_gate_eligible_descent"
    )
    assert (
        direct_followup56_frame_support64_followup5[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "frame"
    )
    assert direct_followup56_frame_support64_followup5[
        "frame_hotspot_block_lstsq_support_size"
    ] == 280
    assert (
        direct_followup56_frame_support64_followup5["output_final_checkpoint_path"]
        is None
    )
    direct_post_frame_support64_translation = rows["G1"]["evidence"][
        "direct_residual_post_frame_support64_block_lstsq_translation_followup4"
    ]
    assert (
        direct_post_frame_support64_translation["base_direct_residual_inf_n"]
        == direct_followup56_frame_support64_followup4["final_direct_residual_inf_n"]
    )
    assert (
        direct_post_frame_support64_translation["final_direct_residual_inf_n"]
        == 5277.174807901489
    )
    assert direct_post_frame_support64_translation["promotion_count"] == 1
    assert direct_post_frame_support64_translation["max_promotions"] == 1
    assert (
        direct_post_frame_support64_translation["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "translation"
    )
    assert direct_post_frame_support64_translation[
        "frame_hotspot_block_lstsq_support_size"
    ] == 334
    assert (
        direct_post_frame_support64_translation["output_final_checkpoint_path"]
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_probe_final_checkpoint.npz"
    )
    direct_post_translation_support64_frame = rows["G1"]["evidence"][
        "direct_residual_post_translation_support64_block_lstsq_frame_followup4"
    ]
    assert (
        direct_post_translation_support64_frame["base_direct_residual_inf_n"]
        == direct_post_frame_support64_translation["final_direct_residual_inf_n"]
    )
    assert (
        direct_post_translation_support64_frame["final_direct_residual_inf_n"]
        == direct_post_frame_support64_translation["final_direct_residual_inf_n"]
    )
    assert direct_post_translation_support64_frame["promotion_count"] == 0
    assert (
        direct_post_translation_support64_frame["stop_reason"]
        == "no_gate_eligible_descent"
    )
    assert (
        direct_post_translation_support64_frame[
            "frame_hotspot_block_lstsq_component_filter"
        ]
        == "frame"
    )
    assert direct_post_translation_support64_frame[
        "frame_hotspot_block_lstsq_support_size"
    ] == 280
    assert direct_post_translation_support64_frame["output_final_checkpoint_path"] is None
    direct_post_frame_support64_translation_support128 = rows["G1"]["evidence"][
    ...
    assert direct_post_frame_support64_translation_support128["promotion_count"] == 1
    assert direct_post_frame_support64_translation_support128["max_promotions"] == 1
    assert (
        direct_post_frame_support64_translation_support128["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128[
    ...
    assert direct_post_frame_support64_translation_support128[
        "frame_hotspot_block_lstsq_support_size"
    ] == 334
    assert (
        direct_post_frame_support64_translation_support128[
    ...
    direct_post_frame_support64_translation_support128_followup3 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup3"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup3[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup2[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup3["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup3[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup3_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup4 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup4"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup4[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup3[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup4["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup4[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup4_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup5 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup5"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup5[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup4[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup5["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup5[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup5_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup6 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup6"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup6[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup5[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup6["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup6[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup6_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup7 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup7"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup7[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup6[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup7["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup7[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup7_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup8 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup8"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup8[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup7[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup8["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup8[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup8_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup9 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup9"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup9[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup8[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup9["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup9[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup9_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup10 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup10"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup10[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup9[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup10["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup10[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup10_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup11 = rows["G1"][
        "evidence"
    ][
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup11["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup11[
    ...
    direct_post_frame_support64_translation_support128_followup14 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup14"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup14[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup13[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup14["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup14[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup14_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup15 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup15"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup15[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup14[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup15["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup15[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup15_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup16 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup16"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup16[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup15[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup16["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup16[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup16_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup17 = rows["G1"][
        "evidence"
    ][
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup17["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup17[
    ...
    direct_post_frame_support64_translation_support128_followup20 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup20"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup20[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup19[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup20["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup20[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup20_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup21 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup21"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup21[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup20[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup21["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup21[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup21_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup22 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup22"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup22[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup21[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup22["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup22[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup22_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup23 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup23"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup23[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup22[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup23["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup23[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup23_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup24 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup24"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup24[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup23[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup24["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup24[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup24_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup25 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup25"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup25[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup24[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup25["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup25[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup25_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup26 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup26"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup26[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup25[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup26["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup26[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup26_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup27 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup27"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup27[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup26[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup27["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup27[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup27_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup28 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup28"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup28[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup27[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup28["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup28[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup28_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup29 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup29"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup29[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup28[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup29["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup29[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup29_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup30 = rows["G1"][
        "evidence"
    ][
        "direct_residual_post_frame_support64_block_lstsq_translation_support128_followup30"
    ]
    assert (
        direct_post_frame_support64_translation_support128_followup30[
            "base_direct_residual_inf_n"
        ]
        == direct_post_frame_support64_translation_support128_followup29[
            "final_direct_residual_inf_n"
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup30["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup30[
    ...
    assert (
        ...
        == "implementation/phase1/release_evidence/productization/mgt_frame_hotspot_block_lstsq_translation_frontier_post_frame_support64_followup4_support128_followup30_probe_final_checkpoint.npz"
    )
    direct_post_frame_support64_translation_support128_followup31 = rows["G1"][
        "evidence"
    ][
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup31["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup31[
    ...
    direct_post_frame_support64_translation_support128_followup34 = rows["G1"][
        "evidence"
    ][
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup34["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup34[
    ...
    direct_post_frame_support64_translation_support128_followup36 = rows["G1"][
        "evidence"
    ][
    ...
    assert (
        direct_post_frame_support64_translation_support128_followup36["stop_reason"]
        == "max_promotions_exhausted"
    )
    assert (
        direct_post_frame_support64_translation_support128_followup36[
    ...
    support128_followup11_components = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup11_component_breakdown"
    ]
    assert support128_followup11_components[
    ...
    support128_followup11_frame_hotspots = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup11_hotspot_frame_diagnostics"
    ]
    assert support128_followup11_frame_hotspots[0]["raw_node_id"] == 11233
    assert (
        support128_followup11_frame_hotspots[0][
            "incident_frame_target_dof_contribution_sum_n"
        ]
        == support128_followup11_frame_hotspots[0]["component_frame_n"]
    )
    assert (
        support128_followup11_frame_hotspots[0][
    ...
    support128_followup11_jvp = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup11_hotspot_jvp"
    ]
    assert support128_followup11_jvp["status"] == "ready"
    assert (
        support128_followup11_jvp["base_residual_inf_n"]
        == direct_post_frame_support64_translation_support128_followup11[
            "final_direct_residual_inf_n"
        ]
    )
    assert support128_followup11_jvp["evaluated_row_count"] == 8
    ...
    support128_followup30_components = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup30_component_breakdown"
    ]
    assert support128_followup30_components[
        "top_row_dominant_component_counts"
    ] == {
        "shell_membrane": 1,
        "frame": 20,
    ...
    support128_followup30_frame_hotspots = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup30_hotspot_frame_diagnostics"
    ]
    assert support128_followup30_frame_hotspots[0]["raw_node_id"] == 11233
    assert (
        support128_followup30_frame_hotspots[0][
            "incident_frame_target_dof_contribution_sum_n"
        ]
        == support128_followup30_frame_hotspots[0]["component_frame_n"]
    )
    support128_followup30_jvp = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup30_hotspot_jvp"
    ]
    assert support128_followup30_jvp["status"] == "partial"
    assert (
        support128_followup30_jvp["base_residual_inf_n"]
        == direct_post_frame_support64_translation_support128_followup30[
            "final_direct_residual_inf_n"
        ]
    )
    assert support128_followup30_jvp["evaluated_row_count"] == 8
    assert support128_followup30_jvp["max_relative_inf_error"] <= 1.0e-12
    assert support128_followup30_jvp["max_relative_l2_error"] <= 1.0e-12
    assert support128_followup30_jvp["min_action_cosine"] >= 0.999999999999
    assert rows["G1"]["evidence"][
    ...
    support128_followup33_components = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup33_component_breakdown"
    ]
    assert support128_followup33_components[
        "top_row_dominant_component_counts"
    ] == {
        "shell_membrane": 1,
        "frame": 20,
    ...
    support128_followup33_frame_hotspots = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup33_hotspot_frame_diagnostics"
    ]
    assert support128_followup33_frame_hotspots[0]["raw_node_id"] == 11233
    assert (
        support128_followup33_frame_hotspots[0][
            "incident_frame_target_dof_contribution_sum_n"
        ]
        == support128_followup33_frame_hotspots[0]["component_frame_n"]
    )
    support128_followup33_jvp = rows["G1"]["evidence"][
        "residual_jacobian_support128_followup33_hotspot_jvp"
    ]
    assert support128_followup33_jvp["status"] == "partial"
    assert (
        support128_followup33_jvp["base_residual_inf_n"]
        == direct_post_frame_support64_translation_support128_followup33[
            "final_direct_residual_inf_n"
        ]
    )
    assert support128_followup33_jvp["evaluated_row_count"] == 8
    assert support128_followup33_jvp["max_relative_inf_error"] <= 1.0e-12
    assert support128_followup33_jvp["max_relative_l2_error"] <= 1.0e-12
