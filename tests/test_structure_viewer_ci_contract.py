...
def test_structure_viewer_contract_runner_covers_source_and_singlefile_surfaces() -> None:
    ...
    assert "tests/test_structure_viewer_commercial_tool_crosswalk_model_contract.py" in script
    assert "tests/test_structure_viewer_review_task_model_contract.py" in script
    assert "tests/test_structure_viewer_solver_receipt_model_contract.py" in script
    assert "tests/test_structure_viewer_evidence_ingest_model_contract.py" in script
...
def test_structure_viewer_contract_runner_has_dry_run_command_preview() -> None:
    ...
    assert "tests/test_structure_viewer_commercial_tool_crosswalk_model_contract.py" in result.stdout
    assert "tests/test_structure_viewer_review_task_model_contract.py" in result.stdout
    assert "tests/test_structure_viewer_solver_receipt_model_contract.py" in result.stdout
    assert "tests/test_structure_viewer_evidence_ingest_model_contract.py" in result.stdout
