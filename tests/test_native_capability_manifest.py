...
def test_native_frontend_contract_capability_is_bounded_c0() -> None:
    ...
    assert "source Viewer browser-smoke wrapper" in frontend["claim"]
    ...
    assert "browser-smoke dry-run binds 0 listeners and spawns 0 processes" in frontend["claim"]
    ...
    assert "retained Playwright prototype smoke still own JavaScript rendering" in frontend["claim"]
