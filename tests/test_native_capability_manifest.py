...
def test_native_frontend_contract_capability_is_bounded_c0() -> None:
    ...
    assert "prototype-browser-smoke/browser-smoke" in frontend["claim"]
    ...
    assert "both browser-smoke dry-runs bind 0 listeners and spawn 0 processes" in frontend["claim"]
    ...
    assert "prototype JavaScript still own JavaScript rendering" in frontend["claim"]
