...
def test_native_distribution_capability_is_bounded_c5():
    ...
    assert "provenance-bound node-coordinate and existing-nodal-load component edits" in distribution["claim"]
    ...
    assert "frozen v1 through v16 receipts" in distribution["claim"]
...
def test_native_deployment_capability_is_bounded_c5() -> None:
    ...
    assert "distribution v17 E2E" in deployment["claim"]
    assert "existing-nodal-load component edits" in deployment["claim"]
