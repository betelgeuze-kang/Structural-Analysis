...
def test_native_distribution_capability_is_bounded_c5():
    ...
    assert "append-only v12 receipt" in distribution["claim"]
    ...
    assert "installed Korean response and deformed views" in distribution["claim"]
    assert "frozen v1 through v11 receipts" in distribution["claim"]
...
def test_native_deployment_capability_is_bounded_c5() -> None:
    ...
    assert "distribution v12 E2E" in deployment["claim"]
