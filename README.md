...
| Corotational 2D fiber-frame arc-length control | implemented | candidate | no | bounded_internal_stateful_arc_length_candidate | internal_python, checkpoint_artifact | stateful_corotational_fiber_frame2d_arc_length_continuation.v1; Bounded dense spherical arc-length continuation supports material-state commit/rollback, adaptive step reduction, source-bound exact checkpoints, and limit-point traversal; unified public API wiring, native sparse execution, external Level 2 comparison, Lee-frame promotion, and release promotion remain open. |
