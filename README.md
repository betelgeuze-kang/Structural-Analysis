...
| Corotational 2D fiber-frame direct displacement control | implemented | candidate | no | bounded_public_direct_displacement_control_candidate | python_api, checkpoint_artifact, internal_python | dense_augmented_consistent_direct_displacement_control.v1; Connected bounded planar corotational fiber frames expose one free UX/UY control DOF through the unified Python result envelope with proportional load factor, proportional support-motion coupling, line search, rollback, exact terminal engineering recovery, and exact checkpoint restart; CLI flags, multiple/general control coordinates, native sparse execution, external Level 2 comparison, and release promotion remain open. |
| Corotational 2D fiber-frame arc-length control | implemented | candidate | no | bounded_public_stateful_arc_length_candidate | python_api, checkpoint_artifact, internal_python | stateful_corotational_fiber_frame2d_arc_length_continuation.v1; Bounded dense spherical arc-length continuation is exposed through the unified Python result envelope with material-state commit/rollback, adaptive step reduction, exact terminal engineering recovery, a composite full frame-ancestry plus continuation-state checkpoint, deterministic genesis replay, and limit-point traversal; CLI flags, multiple/general monitor coordinates, native sparse execution, external Level 2 comparison, Lee-frame promotion, and release promotion remain open. |
