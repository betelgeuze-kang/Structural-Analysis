...
| `source_evidence_freshness` | `age_hours=39.533` | `freshness_pass=true` | `True` |
...
|---|---|---:|---:|---:|
| `implementation/phase1/release_evidence/productization/github_actions_ci_streak_evidence.json` | `github-actions-ci-streak-evidence.v1` | `True` | `39.533` | `False` |
