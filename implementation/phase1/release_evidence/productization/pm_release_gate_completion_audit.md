...
- `summary_line`: `PM release gate completion audit: BLOCKED | requirements=50 | pass=45 | blocked=5`
...
| `release_area.ux` new user completes sample project within 30 minutes | `release_area` | `blocked_external_owner_input_ready` | `ux::human_new_user_observation_missing_or_failed`, `ux::human_new_user_30min_sample_evidence_missing` | ux::human_new_user_observation_missing_or_failed: Attach a human new-user observation record for the sample project workflow, including participant status, observer, timezone-aware start/end timestamps, wall-clock completion minutes, blocker count, evidence reference, and accepted release decision.; ux::human_new_user_30min_sample_evidence_missing: Attach a human new-user observation record for the sample project workflow, including participant status, observer, timezone-aware start/end timestamps, wall-clock completion minutes, blocker count, evidence reference, and accepted release decision. |
