...
| `release_area.github_sync` read-only GitHub sync preflight is clean or explicitly approved | `release_area` | `blocked_handoff_incomplete` | `github_sync::github_sync_preflight::local_head_mismatch` | none |
