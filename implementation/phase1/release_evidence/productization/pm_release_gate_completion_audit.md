...
- `summary_line`: `PM release gate completion audit: BLOCKED | requirements=51 | pass=45 | blocked=6`
...
- `contract_pass`: `False`
- `explicit_requirement_count`: `51`
- `blocked_requirement_count`: `6`
- `blocked_release_area_next_action_missing_count`: `0`

| Requirement | Group | Status | Blockers | Next Action |
|---|---|---|---|---|
| `release_area.basic_ci` PR/nightly 30 consecutive PASS evidence | `release_area` | `blocked_external_owner_input_ready` | `basic_ci::pr_ci_30_consecutive_pass_evidence_missing`, `basic_ci::nightly_ci_30_consecutive_pass_evidence_missing` | basic_ci::pr_ci_30_consecutive_pass_evidence_missing: No pull_request-triggered CI runs have been observed for the CI workflow (100 run(s) queried, all from non-PR events). Open a pull request for this branch or add `pull_request` to the CI workflow triggers, then collect 30 additional consecutive successful PR CI run(s) before release signoff.; basic_ci::nightly_ci_30_consecutive_pass_evidence_missing: Register or enable the nightly GitHub Actions workflow, then collect 30 additional consecutive successful nightly CI run(s) before release signoff. Local workflow file is present, so merge/register it in GitHub Actions first. |
| `release_area.strict_ci` require NDTHA and require HIP or explicit CPU product mode | `release_area` | `pass` | none | none |
| `release_area.evidence_freshness` release evidence generated_at/source commit/engine version/input checksum/reuse marker and producer recency | `release_area` | `blocked_local_remediation_ready` | `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid`, `evidence_freshness::p0_closure_status::source_commit_missing`, `evidence_freshness::p0_closure_status::engine_version_missing`, `evidence_freshness::p0_closure_status::input_checksum_missing`, `evidence_freshness::p0_closure_status::reuse_marker_missing`, `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_readiness_status::source_commit_missing`, `evidence_freshness::p1_readiness_status::engine_version_missing`, `evidence_freshness::p1_readiness_status::input_checksum_missing`, `evidence_freshness::p1_readiness_status::reuse_marker_missing`, `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing`, `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing`, `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing`, `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing` | 15 blockers: Regenerate the referenced P0/P1 release evidence with generated_at, source commit, engine version, input checksum, and reuse marker metadata, then rerun the freshness and PM release reports. |
...
| `release_tier.limited_commercial_full_gate_ready` Limited Commercial release requires full release-area gate readiness | `release_tier` | `blocked` | `basic_ci::pr_ci_30_consecutive_pass_evidence_missing`, `basic_ci::nightly_ci_30_consecutive_pass_evidence_missing`, `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid`, `evidence_freshness::p0_closure_status::source_commit_missing`, `evidence_freshness::p0_closure_status::engine_version_missing`, `evidence_freshness::p0_closure_status::input_checksum_missing`, `evidence_freshness::p0_closure_status::reuse_marker_missing`, `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_readiness_status::source_commit_missing`, `evidence_freshness::p1_readiness_status::engine_version_missing`, `evidence_freshness::p1_readiness_status::input_checksum_missing`, `evidence_freshness::p1_readiness_status::reuse_marker_missing`, `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing`, `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing`, `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing`, `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing`, `ux::human_new_user_observation_missing_or_failed`, `ux::human_new_user_30min_sample_evidence_missing`, `security::license_status_not_configured` | Close all release-area blockers, regenerate the PM release gate, and verify `release_tiers.limited_commercial_full_gate_ready == true` before Limited Commercial promotion. |
