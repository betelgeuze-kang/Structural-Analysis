...
- `summary_line`: `PM release gate completion audit: BLOCKED | requirements=51 | pass=42 | blocked=9`
...
| `release_area.support` known issues, failure bundle, and rollback evidence | `release_area` | `blocked_local_remediation_ready` | `support::pm_failure_bundle_coverage_index_incomplete`, `support::failure_bundle_export_not_green` | support::pm_failure_bundle_coverage_index_incomplete: Resolve `pm_failure_bundle_coverage_index_incomplete` in Support evidence, regenerate PM release reports, and attach the updated evidence.; support::failure_bundle_export_not_green: Resolve `failure_bundle_export_not_green` in Support evidence, regenerate PM release reports, and attach the updated evidence. |
...
| `m5_viewer_mode` reviewer/customer viewer preset | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_pdf_or_reviewer_package` PDF/report or reviewer package generated | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_audit_trail` audit trail has action and source row trace | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_signed_release_registry` release registry is signed | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_support_bundle_export` support bundle one-click export passes | `milestone` | `blocked` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_validation_manual` validation manual is present and complete | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
| `m5_limitation_manual` limitation manual is present and complete | `milestone` | `pass` | `support_bundle_export_missing_or_failed`, `support_bundle_pm_failure_bundle_coverage_incomplete` | none |
