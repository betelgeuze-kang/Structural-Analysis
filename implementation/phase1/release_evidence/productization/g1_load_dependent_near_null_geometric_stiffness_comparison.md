...
- `summary_line`: `G1 load-dependent near-null/geometric-softening comparison: READY | load_response_ready=True | near_null_packets_ready=True | geometric_softening_signal=active_secondary`
- `contract_pass`: `True`
- `promotes_g1_closure`: `False`
- `geometric_softening_signal`: `active_secondary`
- `near_null_packet_comparison_ready`: `True`
