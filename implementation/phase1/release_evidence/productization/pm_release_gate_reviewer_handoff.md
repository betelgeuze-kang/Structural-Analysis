...
- `pm_summary_line`: `PM release gate: LIMITED_MILESTONE_READY | release_areas=BLOCKED | paid_pilot_candidate=True | milestones=5/5 | release_areas_green=11/15 | measured_cases=304`
- `contract_pass`: `True`
...
| `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p0_closure_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p0_closure_status::source_commit_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p0_closure_status::source_commit_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p0_closure_status::engine_version_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p0_closure_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p0_closure_status::input_checksum_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p0_closure_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p0_closure_status::reuse_marker_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p0_closure_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
...
| `evidence_freshness::p1_readiness_status::engine_version_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_readiness_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_readiness_status::input_checksum_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_readiness_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_readiness_status::reuse_marker_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_readiness_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_benchmark_breadth_status::source_commit_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_benchmark_breadth_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
| `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing` | `release_owner` | `local_remediation_ready` | `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`<br>`evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`<br>The owning release-area row has no blocker-specific false check in the PM report.<br>Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match` |
...
| `release_tier.limited_commercial_full_gate_ready` Limited Commercial Full Gate | `blocked` | `basic_ci::pr_ci_30_consecutive_pass_evidence_missing`, `basic_ci::nightly_ci_30_consecutive_pass_evidence_missing`, `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid`, `evidence_freshness::p0_closure_status::source_commit_missing`, `evidence_freshness::p0_closure_status::engine_version_missing`, `evidence_freshness::p0_closure_status::input_checksum_missing`, `evidence_freshness::p0_closure_status::reuse_marker_missing`, `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_readiness_status::source_commit_missing`, `evidence_freshness::p1_readiness_status::engine_version_missing`, `evidence_freshness::p1_readiness_status::input_checksum_missing`, `evidence_freshness::p1_readiness_status::reuse_marker_missing`, `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing`, `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing`, `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing`, `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing`, `ux::human_new_user_observation_missing_or_failed`, `ux::human_new_user_30min_sample_evidence_missing`, `security::license_status_not_configured` | Close all release-area blockers, regenerate the PM release gate, and verify `release_tiers.limited_commercial_full_gate_ready == true` before Limited Commercial promotion. | Limited Commercial cannot be promoted while release-area blockers remain open, even when milestone evidence is green. |
| `release_tier.ga_enterprise_evidence_gate_pass` GA / Enterprise Evidence Gate | `blocked` | `independent_vv_missing`, `family_validation_manual_signoff_missing`, `customer_audit_failure_bundle_sla_missing`, `basic_ci::pr_ci_30_consecutive_pass_evidence_missing`, `basic_ci::nightly_ci_30_consecutive_pass_evidence_missing`, `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid`, `evidence_freshness::p0_closure_status::source_commit_missing`, `evidence_freshness::p0_closure_status::engine_version_missing`, `evidence_freshness::p0_closure_status::input_checksum_missing`, `evidence_freshness::p0_closure_status::reuse_marker_missing`, `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_readiness_status::source_commit_missing`, `evidence_freshness::p1_readiness_status::engine_version_missing`, `evidence_freshness::p1_readiness_status::input_checksum_missing`, `evidence_freshness::p1_readiness_status::reuse_marker_missing`, `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid`, `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing`, `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing`, `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing`, `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing`, `ux::human_new_user_observation_missing_or_failed`, `ux::human_new_user_30min_sample_evidence_missing`, `security::license_status_not_configured` | Attach independent V&V attestation, family validation-manual signoff, and customer audit/failure-bundle/SLA approval evidence before GA/Enterprise release. | GA still requires independent V&V, family validation manuals, signed release registry, customer audit/failure bundles, and support SLA; this report only verifies local evidence inputs. |
...
### `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid`
...
- `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid` absent from `release_area_blockers`
...
- `evidence_freshness::p0_closure_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p0_closure_status::source_commit_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p0_closure_status::source_commit_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p0_closure_status::source_commit_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p0_closure_status::engine_version_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p0_closure_status::engine_version_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p0_closure_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p0_closure_status::input_checksum_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p0_closure_status::input_checksum_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p0_closure_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p0_closure_status::reuse_marker_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p0_closure_status::reuse_marker_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p0_closure_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_readiness_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_readiness_status::source_commit_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_readiness_status::source_commit_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_readiness_status::source_commit_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_readiness_status::engine_version_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_readiness_status::engine_version_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_readiness_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_readiness_status::input_checksum_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_readiness_status::input_checksum_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_readiness_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_readiness_status::reuse_marker_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_readiness_status::reuse_marker_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_readiness_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_benchmark_breadth_status::generated_at_missing_or_invalid` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_benchmark_breadth_status::source_commit_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_benchmark_breadth_status::engine_version_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_benchmark_breadth_status::input_checksum_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`

### `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing`
...
- `release_evidence_freshness_report.json.contract_pass == true`
- `source_commit_rows_match`, `engine_version_rows_present`, `input_checksum_rows_present`, `reuse_marker_rows_present`, and `dependency_mtime_rows_pass` are true in `pm_release_gate_report.json`
- `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing` absent from `release_area_blockers`
...
Verdict change conditions:
- `release_area.evidence_freshness` status is `pass` in `pm_release_gate_completion_audit.json`
- `evidence_freshness::p1_benchmark_breadth_status::reuse_marker_missing` is absent from `pm_release_gate_report.json.release_area_blockers`
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `engine_version_rows_present`, `input_checksum_rows_present`, `release_evidence_freshness_contract_pass`, `reuse_marker_rows_present`, `source_commit_rows_match`
