...
- `summary_line`: `PM release gate reviewer handoff: PASS | open_blockers=15 | incomplete=0 | release_tiers=2/4`
...
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `github_sync_main_synced_to_head`, `github_sync_preflight_clean`, `github_sync_preflight_head_matches_current`
