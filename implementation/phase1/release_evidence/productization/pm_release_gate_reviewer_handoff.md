...
- The owning release-area row has no blocker-specific false check in the PM report.
- Current false audit check(s): `github_sync_main_synced_to_head`, `github_sync_preflight_clean`, `github_sync_worktree_clean`
