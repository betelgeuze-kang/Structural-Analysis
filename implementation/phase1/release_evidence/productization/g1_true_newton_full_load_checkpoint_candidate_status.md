...
- `summary_line`: `G1 true-Newton full-load checkpoint candidate: CANDIDATE_CREATED | checkpoint_written=True | final_residual=1384.2531989367426 | residual_gate=False`
- `contract_pass`: `True`
...
- `steps`: `36`
- `final_residual_n`: `1384.2531989367426`
