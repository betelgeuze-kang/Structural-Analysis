...
- `summary_line`: `G1 true-Newton full-load checkpoint candidate: CANDIDATE_CREATED | checkpoint_written=True | final_residual=747.4190104793868 | residual_gate=False`
- `contract_pass`: `True`
...
- `steps`: `24`
- `final_residual_n`: `747.4190104793868`
