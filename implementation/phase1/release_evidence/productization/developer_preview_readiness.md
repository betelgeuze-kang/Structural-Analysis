...
- `blocker_count`: `19`
- `future_commercial_blocker_count`: `31`
- `source_commit_sha`: `1c60b6e1af7af5e9ea137de8946ef27951a93c80`
...
| numerical | 6 | yes |
| benchmark | 0 | yes |
| software product | 13 | yes |
| future commercial | 31 | no, future commercial only |
