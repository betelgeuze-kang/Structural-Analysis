...
- `blocker_count`: `22`
- `future_commercial_blocker_count`: `29`
- `source_commit_sha`: `4e21e33a7db60ec6ac8b38394c0b3ec02393e40a`
...
| numerical | 6 | yes |
| benchmark | 0 | yes |
| software product | 16 | yes |
| future commercial | 29 | no, future commercial only |
