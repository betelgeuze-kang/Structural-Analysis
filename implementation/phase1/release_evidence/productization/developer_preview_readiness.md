...
- `blocker_count`: `7`
- `future_commercial_blocker_count`: `30`
- `source_commit_sha`: `c5a4dd85f2384f2b682287f22c0787e9760859be`
...
| numerical | 4 | yes |
| benchmark | 0 | yes |
| software product | 3 | yes |
| future commercial | 30 | no, future commercial only |
