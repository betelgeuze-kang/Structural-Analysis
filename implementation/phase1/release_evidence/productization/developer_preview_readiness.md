...
- `blocker_count`: `31`
- `future_commercial_blocker_count`: `34`
- `source_commit_sha`: `4f289c801e8fe8a3e06cdc73833ed668df7a69e4`
...
| numerical | 6 | yes |
| benchmark | 0 | yes |
| software product | 25 | yes |
| future commercial | 34 | no, future commercial only |
