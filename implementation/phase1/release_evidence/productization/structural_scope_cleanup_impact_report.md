...
- `summary_line`: `Structural scope cleanup impact report: BLOCKED_CLEANUP_IMPACT | quarantined=86 | references=113 | blocking=64 | owner_pending=86`
- `contract_pass`: `False`
- `cleanup_impact_clear`: `False`
- `quarantined_path_count`: `86`
- `reference_path_count`: `113`
- `blocking_cleanup_reference_path_count`: `64`
...
- `reference_role_counts`: `{'documentation_reference': 1, 'implementation_runtime_or_manifest_reference': 41, 'other_reference': 1, 'release_governance_reference': 19, 'scope_governance_reference': 30, 'script_reference': 9, 'test_reference': 12}`
- `blocking_reference_role_counts`: `{'documentation_reference': 1, 'implementation_runtime_or_manifest_reference': 41, 'other_reference': 1, 'script_reference': 9, 'test_reference': 12}`
- `blocking_reference_cleanup_action_counts`: `{'delete_or_extract_molecular_script_or_remove_quarantined_path_refs': 9, 'delete_or_extract_molecular_tests_or_update_scope_guard_tests': 12, 'remove_md3bead_runtime_manifest_or_regenerate_structural_runtime_artifacts': 41, 'remove_non_structural_scope_ignore_or_metadata_reference': 1, 'rewrite_structural_docs_to_scope_boundary_only': 1}`

## Cleanup Batches

| Batch | Priority | Role | Paths | Source-Boundary Paths | Action |
|---|---:|---|---:|---:|---|
| `cleanup_refs_02_implementation_runtime_or_manifest_reference` | 2 | `implementation_runtime_or_manifest_reference` | 41 | 1 | `remove_md3bead_runtime_manifest_or_regenerate_structural_runtime_artifacts` |
