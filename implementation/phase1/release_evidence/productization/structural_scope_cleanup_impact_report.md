...
- `summary_line`: `Structural scope cleanup impact report: BLOCKED_CLEANUP_IMPACT | quarantined=86 | references=133 | blocking=84 | owner_pending=86`
- `contract_pass`: `False`
- `cleanup_impact_clear`: `False`
- `quarantined_path_count`: `86`
- `reference_path_count`: `133`
- `blocking_cleanup_reference_path_count`: `84`
...
- `reference_role_counts`: `{'documentation_reference': 2, 'implementation_runtime_or_manifest_reference': 48, 'other_reference': 1, 'productization_evidence_reference': 10, 'release_governance_reference': 19, 'scope_governance_reference': 30, 'script_reference': 10, 'test_reference': 13}`
- `blocking_reference_role_counts`: `{'documentation_reference': 2, 'implementation_runtime_or_manifest_reference': 48, 'other_reference': 1, 'productization_evidence_reference': 10, 'script_reference': 10, 'test_reference': 13}`
