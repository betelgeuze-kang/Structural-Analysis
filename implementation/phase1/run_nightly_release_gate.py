...
REASONS = {
    ...
    "ERR_DELIVERY_EVIDENCE_BUNDLE": "delivery evidence bundle gate failed",
    "ERR_GAP_CLOSURE_STATUS": "gap closure status report failed",
    "ERR_VERIFY_DELIVERY_EVIDENCE": "delivery evidence verification failed",
    "ERR_VALIDATE_PRODUCTIZATION_DELIVERY": "productization delivery validation failed",
...
def main() -> None:
    ...
    p.add_argument("--producer-cmd", default="python3 implementation/phase1/structural_runtime_hook.py")
    ...
    def _release_registry_cmd() -> list[str]:
        return [
            ...
            "--external-benchmark-kickoff-markdown",
            ...
            "--external-benchmark-execution-manifest-markdown",
            str(Path(args.external_benchmark_kickoff_dir) / "external_benchmark_execution_manifest.md"),
            "--external-benchmark-execution-status",
            str(args.external_benchmark_execution_status_manifest_report),
            "--external-benchmark-execution-status-markdown",
            str(Path(args.external_benchmark_kickoff_dir) / "external_benchmark_execution_status_manifest.md"),
            "--case-onepage-attestation-index",
            str(Path(args.external_benchmark_kickoff_dir) / "case_onepage_attestation_index.json"),
            "--case-onepage-attestation-index-markdown",
            str(Path(args.external_benchmark_kickoff_dir) / "case_onepage_attestation_index.md"),
            "--audit-review-decision-batch-template",
            str(args.audit_review_decision_batch_template_json),
            "--audit-review-decision-batch-template-markdown",
            str(Path(args.audit_review_decision_batch_template_json).with_suffix(".md")),
            "--approve-all-submission-readiness-preview",
            str(Path(args.external_benchmark_kickoff_dir) / "external_benchmark_submission_readiness_preview.approve_all.json"),
            "--approve-all-submission-readiness-preview-markdown",
            str(Path(args.external_benchmark_kickoff_dir) / "external_benchmark_submission_readiness_preview.approve_all.md"),
            "--exact-topology-structural-preview-promotion-queue",
            str(Path(args.external_benchmark_kickoff_dir).parent / "midas_native_roundtrip" / "exact_topology_structural_preview_promotion_queue.json"),
            "--exact-topology-structural-preview-promotion-queue-markdown",
            str(Path(args.external_benchmark_kickoff_dir).parent / "midas_native_roundtrip" / "exact_topology_structural_preview_promotion_queue.md"),
            "--public-key-out",
    ...
    if reason_code == "PASS":
        ...
        cmd_delivery_evidence_bundle = [
            sys.executable,
            "scripts/run_delivery_evidence_bundle.py",
            "--changes-json",
            str(args.design_opt_cost_reduction_changes_source_evidence),
            "--roundtrip-json",
            MIDAS_SECTION_LIBRARY_ARTIFACTS[2],
            "--output-json",
