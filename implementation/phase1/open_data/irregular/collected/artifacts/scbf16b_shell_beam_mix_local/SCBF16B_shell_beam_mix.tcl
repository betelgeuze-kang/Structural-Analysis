...
# Added shell diaphragms for shell-beam mix topology gate (parser-only topology contract).
# These elements reuse existing frame nodes so shell+beam connectivity is present in one graph.
element ShellMITC4 990001 211 221 231 241 1
element ShellMITC4 990002 221 230 240 231 1
element ShellMITC4 990003 311 321 331 341 1
element ShellMITC4 990004 321 330 340 331 1
element ShellMITC4 990005 411 421 431 441 1
