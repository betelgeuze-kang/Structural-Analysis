...
- Generated at: `2026-03-20T10:11:55.820252+00:00`
...
- MIDAS optimized export artifact present: `True` (contract_pass=`True`, support_mode=`bounded_patch_subset`, supported_changes=`25`, unsupported_changes=`0`, direct_patch_changes=`8`, direct_patch_families=`beam_section=1, slab_thickness=2, wall_thickness=5`, rebar_namespace_mode=`material_level_only`, rebar_material_namespace_present=`True`, rebar_group_local_namespace_present=`False`, material_rebar_payloads=`0/5`, group_local_rebar_payloads=`0/0`, rebar_direct_patch_eligible=`0`, patched_material_rows=`0`, cloned_materials=`0`, rebar_delivery_mode=`structured_sidecar_only`, evidence_model=`direct_patch_plus_structured_sidecar`, rebar_direct_patch_blockers=`material_payload_missing=3, mixed_material_scope=3`, rebar_mapping_sources=`alt_slab_wall_group_id=5, direct_group_id=1`, sidecar_families=`connection_detailing=6, detailing=5, perimeter_frame=1, rebar=5`, sidecar_priorities=`high=12, medium=5`, sidecar_followups=`connection_detailing_manual_update=6, detailing_manual_review=5, perimeter_frame_manual_update=1, rebar_manual_update=5`, cloned_sections=`0`, cloned_thicknesses=`6`, retargeted_elements=`77`)
- MGT delivery boundary: `direct_patch_plus_structured_sidecar` | `direct_patch=beam_section=1, slab_thickness=2, wall_thickness=5 | sidecar=connection_detailing=6, detailing=5, perimeter_frame=1, rebar=5`
...
- `mgt_export_direct_patch_change_count`: `8`
...
- `mgt_export_direct_patch_action_family_counts`: `{'beam_section': 1, 'slab_thickness': 2, 'wall_thickness': 5}`
...
- `mgt_export_rebar_direct_patch_ineligible_reason_counts`: `{'material_payload_missing': 3, 'mixed_material_scope': 3}`
- `mgt_export_rebar_direct_patch_ineligible_reason_label`: `material_payload_missing=3, mixed_material_scope=3`
...
- `mgt_export_delivery_boundary`: `direct_patch=beam_section=1, slab_thickness=2, wall_thickness=5 | sidecar=connection_detailing=6, detailing=5, perimeter_frame=1, rebar=5`
- `mgt_export_instruction_sidecar_change_count`: `17`
- `mgt_export_instruction_sidecar_action_family_counts`: `{'connection_detailing': 6, 'detailing': 5, 'perimeter_frame': 1, 'rebar': 5}`
- `mgt_export_instruction_sidecar_action_family_label`: `connection_detailing=6, detailing=5, perimeter_frame=1, rebar=5`
- `mgt_export_instruction_sidecar_review_priority_counts`: `{'high': 12, 'medium': 5}`
- `mgt_export_instruction_sidecar_review_priority_label`: `high=12, medium=5`
- `mgt_export_instruction_sidecar_followup_type_counts`: `{'connection_detailing_manual_update': 6, 'detailing_manual_review': 5, 'perimeter_frame_manual_update': 1, 'rebar_manual_update': 5}`
- `mgt_export_instruction_sidecar_followup_type_label`: `connection_detailing_manual_update=6, detailing_manual_review=5, perimeter_frame_manual_update=1, rebar_manual_update=5`
...
- `mgt_export_retargeted_element_row_count`: `77`
...
- `MIDAS exporter now emits bounded optimized patches`: artifact_exists=True, contract_pass=True, support_mode=bounded_patch_subset, supported_changes=25, unsupported_changes=0, cloned_sections=0, cloned_thicknesses=6, retargeted_elements=77, patched_section_scale_rows=1, patched_thickness_rows=7
...
- Evidence: midas_conversion_pass=True, semantic_load_binding_pass=True, optimized_mgt_export_exists=True, export_contract_pass=True, support_mode=bounded_patch_subset, supported_changes=25, unsupported_changes=0, cloned_sections=0, cloned_thicknesses=6, retargeted_elements=77, design_opt_changes_json=implementation/phase1/release/design_optimization/design_optimization_cost_reduction_changes.json
