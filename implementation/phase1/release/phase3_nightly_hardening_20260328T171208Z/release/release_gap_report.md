...
- Generated at: `2026-03-28T17:11:51.652873+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=5): `2.58 min` (range `0.59-5.36 min`)
- Current measured chain wall-clock: `0.59 min`
...
- Measured accelerated chain wall-clock (comparable rolling N=5): `2.58 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=16` | `comparable_samples=5` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.59 min`
...
- `measured_chain_breakdown_min`: parser/screening `0.16`, analysis/optimization `0.39`, nonseismic/construction `0.00`, authority/crosscheck `0.04`, release/packaging `0.01`
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `1.88`, authority/crosscheck `0.12`, release/packaging `0.05`
