...
- Generated at: `2026-03-29T03:46:45.079211+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=12): `1.60 min` (range `0.59-5.36 min`)
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7) | interaction_family=yes(152/152) | interaction_sources=10/10 | groups=shell-shell=48/48,shell-wall=48/48,footing-soil=48/48,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- Material constitutive gate: `Material constitutive gate: PASS | concrete_damage=yes(matrix=35/35,max=1.000) | cyclic_degradation=yes(matrix=34/34,residual_max=1.914%) | bond_interface=yes(matrix=36/36,bond_max=0.980) | matrix=105/105 | groups=concrete_damage=35/35,cyclic_degradation=34/34,bond_interface=36/36 | coverage=cd[t=2,h=2,s=2,sf=10],cyc[t=2,h=2,store=1,sf=10],bond[t=2,h=2,s=2,sf=10]`
...
- Surface interaction benchmark: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=152/152 | source_families=10/10 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=48/48,shell-wall=48/48,footing-soil=48/48,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- `material_constitutive_summary_line`: `Material constitutive gate: PASS | concrete_damage=yes(matrix=35/35,max=1.000) | cyclic_degradation=yes(matrix=34/34,residual_max=1.914%) | bond_interface=yes(matrix=36/36,bond_max=0.980) | matrix=105/105 | groups=concrete_damage=35/35,cyclic_degradation=34/34,bond_interface=36/36 | coverage=cd[t=2,h=2,s=2,sf=10],cyc[t=2,h=2,store=1,sf=10],bond[t=2,h=2,s=2,sf=10]`
...
- `surface_interaction_benchmark_summary_line`: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=152/152 | source_families=10/10 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=48/48,shell-wall=48/48,footing-soil=48/48,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- Measured accelerated chain wall-clock (comparable rolling N=12): `1.60 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=23` | `comparable_samples=12` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.91 min`
...
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `0.85`, authority/crosscheck `0.14`, release/packaging `0.06`
