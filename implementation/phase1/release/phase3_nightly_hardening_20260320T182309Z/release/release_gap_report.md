...
- Generated at: `2026-03-20T18:22:44.532631+00:00`
...
- MIDAS optimized export artifact present: `True` (contract_pass=`True`, support_mode=`bounded_patch_subset`, supported_changes=`32`, unsupported_changes=`0`, direct_patch_changes=`21`, direct_patch_families=`beam_section=1, connection_detailing=6, detailing=1, perimeter_frame=1, rebar=5, slab_thickness=2, wall_thickness=5`, rebar_namespace_mode=`group_local`, rebar_material_namespace_present=`True`, rebar_group_local_namespace_present=`True`, material_rebar_payloads=`3/5`, group_local_rebar_payloads=`6/6`, group_local_connection_detailing_payloads=`6/6`, connection_direct_patch_eligible=`6`, group_local_detailing_payloads=`5/5`, connection_namespace_mode=`group_local`, connection_group_local_namespace_present=`True`, connection_structured_payload_mapped=`6`, connection_delivery_mode=`direct_patch_metadata_plus_sidecar`, detailing_namespace_mode=`group_local`, detailing_group_local_namespace_present=`True`, detailing_direct_patch_eligible=`1`, detailing_structured_payload_mapped=`5`, detailing_delivery_mode=`direct_patch_metadata_plus_sidecar`, rebar_direct_patch_eligible=`6`, patched_material_rows=`16`, cloned_materials=`16`, rebar_delivery_mode=`direct_patch_eligible`, evidence_model=`direct_patch_plus_structured_sidecar`, rebar_direct_patch_blockers=``, rebar_mapping_sources=`alt_slab_wall_group_id=5, direct_group_id=1`, sidecar_families=`connection_detailing=6, detailing=5`, sidecar_priorities=`high=6, medium=5`, sidecar_followups=`connection_detailing_audit_after_material_patch=6, detailing_audit_after_material_patch=1, detailing_manual_review=4`, cloned_sections=`0`, cloned_thicknesses=`6`, retargeted_elements=`240`)
- MGT delivery boundary: `direct_patch_plus_structured_sidecar` | `direct_patch=beam_section=1, connection_detailing=6, detailing=1, perimeter_frame=1, rebar=5, slab_thickness=2, wall_thickness=5 | sidecar=connection_detailing=6, detailing=5 | connection_payload=direct_patch_metadata_plus_sidecar | detailing_payload=direct_patch_metadata_plus_sidecar`
...
- `mgt_export_supported_change_count`: `32`
- `mgt_export_unsupported_change_count`: `0`
- `mgt_export_direct_patch_change_count`: `21`
...
- `mgt_export_direct_patch_action_family_counts`: `{'beam_section': 1, 'connection_detailing': 6, 'detailing': 1, 'perimeter_frame': 1, 'rebar': 5, 'slab_thickness': 2, 'wall_thickness': 5}`
- `mgt_export_direct_patch_action_family_label`: `beam_section=1, connection_detailing=6, detailing=1, perimeter_frame=1, rebar=5, slab_thickness=2, wall_thickness=5`
...
- `mgt_export_delivery_boundary`: `direct_patch=beam_section=1, connection_detailing=6, detailing=1, perimeter_frame=1, rebar=5, slab_thickness=2, wall_thickness=5 | sidecar=connection_detailing=6, detailing=5 | connection_payload=direct_patch_metadata_plus_sidecar | detailing_payload=direct_patch_metadata_plus_sidecar`
- `mgt_export_instruction_sidecar_change_count`: `11`
- `mgt_export_instruction_sidecar_action_family_counts`: `{'connection_detailing': 6, 'detailing': 5}`
- `mgt_export_instruction_sidecar_action_family_label`: `connection_detailing=6, detailing=5`
- `mgt_export_instruction_sidecar_review_priority_counts`: `{'high': 6, 'medium': 5}`
- `mgt_export_instruction_sidecar_review_priority_label`: `high=6, medium=5`
- `mgt_export_instruction_sidecar_followup_type_counts`: `{'connection_detailing_audit_after_material_patch': 6, 'detailing_audit_after_material_patch': 1, 'detailing_manual_review': 4}`
- `mgt_export_instruction_sidecar_followup_type_label`: `connection_detailing_audit_after_material_patch=6, detailing_audit_after_material_patch=1, detailing_manual_review=4`
- `mgt_export_patched_material_row_count`: `16`
- `mgt_export_cloned_section_count`: `0`
- `mgt_export_cloned_thickness_count`: `6`
- `mgt_export_cloned_material_count`: `16`
- `mgt_export_retargeted_element_row_count`: `240`
...
- `MIDAS exporter now emits bounded optimized patches`: artifact_exists=True, contract_pass=True, support_mode=bounded_patch_subset, supported_changes=32, unsupported_changes=0, cloned_sections=0, cloned_thicknesses=6, retargeted_elements=240, patched_section_scale_rows=1, patched_thickness_rows=7
...
- Evidence: midas_conversion_pass=True, semantic_load_binding_pass=True, optimized_mgt_export_exists=True, export_contract_pass=True, support_mode=bounded_patch_subset, supported_changes=32, unsupported_changes=0, cloned_sections=0, cloned_thicknesses=6, retargeted_elements=240, design_opt_changes_json=implementation/phase1/release/design_optimization/design_optimization_cost_reduction_changes.json
