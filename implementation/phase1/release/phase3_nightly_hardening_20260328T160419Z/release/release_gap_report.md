...
- Generated at: `2026-03-28T16:04:02.335450+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=3): `3.82 min` (range `0.87-5.36 min`)
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7)`
- Element/material breadth: `Element/material breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14) | contact=full_structural_contact | materials=2(rc_composite,steel_elastic_plastic) | links=6(bearing_bilinear,compression_only_penalty,coulomb_friction,kelvin_voigt_pounding,normal_gap_unilateral,uplift_seat_unilateral) | capabilities=7(dissipative_device_response,foundation_soil_link_nonlinear,rc_bond_slip,rc_cracking,rc_creep_shrinkage,slab_wall_interaction,soil_boundary_nonlinear)`
...
- Surface interaction benchmark: `Surface interaction benchmark: PASS | ready=7/7 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6`
...
- `solver_breadth_summary_line`: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7)`
...
- `surface_interaction_benchmark_summary_line`: `Surface interaction benchmark: PASS | ready=7/7 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T16:03:57.761928+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=3): `3.82 min` (range `0.87-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=14` | `comparable_samples=3` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.87 min`
- Basis: `Empirical estimate derived from nightly design-optimization smoke runtime reduction, scaled by the accelerated-coverage target. smoke_mean_runtime_saved=95.96%, sample_count=10.`
- Empirical smoke runtime reduction: `95.38-96.28%` (mean `95.96%`)
...
- `measured_chain_breakdown_mean_min`: parser/screening `0.15`, analysis/optimization `0.37`, nonseismic/construction `3.10`, authority/crosscheck `0.13`, release/packaging `0.07`
...
- `runtime_drift`: baseline `1.3226s -> 1.3773s` (`+0.0547s`), trial `0.0543s -> 0.0513s` (`-0.0030s`)
