...
- Generated at: `2026-03-28T17:34:08.901406+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=7): `2.10 min` (range `0.59-5.36 min`)
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7) | interaction_family=yes(35/35) | interaction_sources=3/3 | groups=shell-shell=9/9,shell-wall=9/9,footing-soil=9/9,direct-contact=6/6`
...
- Material constitutive gate: `Material constitutive gate: PASS | concrete_damage=yes(matrix=15/15,max=1.000) | cyclic_degradation=yes(matrix=14/14,residual_max=1.914%) | bond_interface=yes(matrix=16/16,bond_max=0.980) | matrix=45/45 | groups=concrete_damage=15/15,cyclic_degradation=14/14,bond_interface=16/16 | coverage=cd[t=2,h=2,s=2],cyc[t=2,h=2,store=1],bond[t=2,h=2,s=2]`
...
- Surface interaction benchmark: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=35/35 | source_families=3/3 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=9/9,shell-wall=9/9,footing-soil=9/9,direct-contact=6/6`
...
- `material_constitutive_summary_line`: `Material constitutive gate: PASS | concrete_damage=yes(matrix=15/15,max=1.000) | cyclic_degradation=yes(matrix=14/14,residual_max=1.914%) | bond_interface=yes(matrix=16/16,bond_max=0.980) | matrix=45/45 | groups=concrete_damage=15/15,cyclic_degradation=14/14,bond_interface=16/16 | coverage=cd[t=2,h=2,s=2],cyc[t=2,h=2,store=1],bond[t=2,h=2,s=2]`
...
- `surface_interaction_benchmark_summary_line`: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=35/35 | source_families=3/3 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=9/9,shell-wall=9/9,footing-soil=9/9,direct-contact=6/6`
...
- Measured accelerated chain wall-clock (comparable rolling N=7): `2.10 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=18` | `comparable_samples=7` | `reference_steps=19` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.89 min`
...
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `1.38`, authority/crosscheck `0.13`, release/packaging `0.06`
...
- `summary`: `MIDAS KDS row provenance export: PASS | combos=6 | rows=144 | members=12 | clauses=6 | exact_rows=144`
