...
- Generated at: `2026-03-22T07:05:30.282637+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=1): `5.24 min` (range `5.24-5.24 min`)
- Current measured chain wall-clock: `0.00 min`
...
- `mgt_export_audit_review_followup_oldest_open_age_hours`: `11.465086`
- `mgt_export_audit_review_followup_oldest_open_packet_id`: `detailing|detailing_audit_after_material_patch|medium`
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-21T18:45:18.865784+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=1): `5.24 min` (range `5.24-5.24 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=12` | `comparable_samples=1` | `reference_steps=19` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.00 min`
...
- `measured_chain_breakdown_min`: parser/screening `0.00`, analysis/optimization `0.00`, nonseismic/construction `0.00`, authority/crosscheck `0.00`, release/packaging `0.00`
- `measured_chain_breakdown_mean_min`: parser/screening `0.14`, analysis/optimization `0.36`, nonseismic/construction `4.60`, authority/crosscheck `0.07`, release/packaging `0.07`
