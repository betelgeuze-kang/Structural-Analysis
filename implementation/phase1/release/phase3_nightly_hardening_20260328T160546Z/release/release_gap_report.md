...
- Generated at: `2026-03-28T16:05:29.637861+00:00`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T16:05:25.142215+00:00`
...
- Current measured chain wall-clock: `0.87 min`
- Basis: `Empirical estimate derived from nightly design-optimization smoke runtime reduction, scaled by the accelerated-coverage target. smoke_mean_runtime_saved=96.00%, sample_count=10.`
- Empirical smoke runtime reduction: `95.38-96.32%` (mean `96.00%`)
- `measured_chain_breakdown_min`: parser/screening `0.16`, analysis/optimization `0.37`, nonseismic/construction `0.12`, authority/crosscheck `0.15`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.3601s -> 1.4016s` (`+0.0415s`), trial `0.0511s -> 0.0515s` (`+0.0004s`)
