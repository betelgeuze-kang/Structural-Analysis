...
- Generated at: `2026-03-28T16:51:27.316937+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=4): `3.08 min` (range `0.86-5.36 min`)
- Current measured chain wall-clock: `0.86 min`
...
- Measured accelerated chain wall-clock (comparable rolling N=4): `3.08 min` (range `0.86-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=15` | `comparable_samples=4` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.86 min`
...
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.37`, nonseismic/construction `2.35`, authority/crosscheck `0.14`, release/packaging `0.06`
