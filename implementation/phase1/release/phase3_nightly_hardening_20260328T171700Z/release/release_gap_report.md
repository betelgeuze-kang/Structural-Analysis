...
- Generated at: `2026-03-28T17:16:44.013558+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=6): `2.30 min` (range `0.59-5.36 min`)
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T17:16:38.533674+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=6): `2.30 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=17` | `comparable_samples=6` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.89 min`
...
- `measured_chain_breakdown_min`: parser/screening `0.15`, analysis/optimization `0.39`, nonseismic/construction `0.12`, authority/crosscheck `0.16`, release/packaging `0.07`
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `1.59`, authority/crosscheck `0.13`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.3750s -> 1.3967s` (`+0.0218s`), trial `0.0551s -> 0.0568s` (`+0.0017s`)
