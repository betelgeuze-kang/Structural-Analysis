...
- Generated at: `2026-03-29T03:29:34.663447+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=10): `1.74 min` (range `0.59-5.36 min`)
...
- Measured accelerated chain wall-clock (comparable rolling N=10): `1.74 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=21` | `comparable_samples=10` | `reference_steps=19` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.90 min`
...
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `1.00`, authority/crosscheck `0.14`, release/packaging `0.06`
