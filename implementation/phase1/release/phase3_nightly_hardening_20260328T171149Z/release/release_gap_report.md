...
- Generated at: `2026-03-28T17:10:27.253562+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=5): `2.64 min` (range `0.86-5.36 min`)
- Current measured chain wall-clock: `0.87 min`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T16:51:21.893264+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=5): `2.64 min` (range `0.86-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=16` | `comparable_samples=5` | `reference_steps=19` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.87 min`
...
- `measured_chain_breakdown_min`: parser/screening `0.15`, analysis/optimization `0.37`, nonseismic/construction `0.12`, authority/crosscheck `0.16`, release/packaging `0.06`
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.37`, nonseismic/construction `1.90`, authority/crosscheck `0.14`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.3700s -> 1.4464s` (`+0.0764s`), trial `0.0566s -> 0.0607s` (`+0.0042s`)
