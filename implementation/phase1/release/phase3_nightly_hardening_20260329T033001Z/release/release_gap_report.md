...
- Generated at: `2026-03-29T03:29:45.703565+00:00`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-29T03:29:40.209235+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=10): `1.74 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=21` | `comparable_samples=10` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.91 min`
- Basis: `Empirical estimate derived from nightly design-optimization smoke runtime reduction, scaled by the accelerated-coverage target. smoke_mean_runtime_saved=96.01%, sample_count=10.`
- Empirical smoke runtime reduction: `95.8-96.32%` (mean `96.01%`)
- `measured_chain_breakdown_min`: parser/screening `0.18`, analysis/optimization `0.38`, nonseismic/construction `0.12`, authority/crosscheck `0.16`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.4016s -> 1.4371s` (`+0.0355s`), trial `0.0515s -> 0.0567s` (`+0.0051s`)
