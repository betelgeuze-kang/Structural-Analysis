...
- Generated at: `2026-03-28T18:36:43.217969+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=9): `1.83 min` (range `0.59-5.36 min`)
- Current measured chain wall-clock: `0.90 min`
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7) | interaction_family=yes(80/80) | interaction_sources=5/6 | groups=shell-shell=24/24,shell-wall=24/24,footing-soil=24/24,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- Material constitutive gate: `Material constitutive gate: PASS | concrete_damage=yes(matrix=27/27,max=1.000) | cyclic_degradation=yes(matrix=26/26,residual_max=1.914%) | bond_interface=yes(matrix=28/28,bond_max=0.980) | matrix=81/81 | groups=concrete_damage=27/27,cyclic_degradation=26/26,bond_interface=28/28 | coverage=cd[t=2,h=2,s=2,sf=6],cyc[t=2,h=2,store=1,sf=6],bond[t=2,h=2,s=2,sf=6]`
...
- `material_constitutive_summary_line`: `Material constitutive gate: PASS | concrete_damage=yes(matrix=27/27,max=1.000) | cyclic_degradation=yes(matrix=26/26,residual_max=1.914%) | bond_interface=yes(matrix=28/28,bond_max=0.980) | matrix=81/81 | groups=concrete_damage=27/27,cyclic_degradation=26/26,bond_interface=28/28 | coverage=cd[t=2,h=2,s=2,sf=6],cyc[t=2,h=2,store=1,sf=6],bond[t=2,h=2,s=2,sf=6]`
...
- `surface_interaction_benchmark_summary_line`: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=80/80 | source_families=5/6 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=24/24,shell-wall=24/24,footing-soil=24/24,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T18:36:37.636720+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=9): `1.83 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=20` | `comparable_samples=9` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.90 min`
- Basis: `Empirical estimate derived from nightly design-optimization smoke runtime reduction, scaled by the accelerated-coverage target. smoke_mean_runtime_saved=96.04%, sample_count=10.`
- Empirical smoke runtime reduction: `95.8-96.32%` (mean `96.04%`)
- `measured_chain_breakdown_min`: parser/screening `0.16`, analysis/optimization `0.39`, nonseismic/construction `0.12`, authority/crosscheck `0.16`, release/packaging `0.07`
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `1.10`, authority/crosscheck `0.14`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.3773s -> 1.4200s` (`+0.0427s`), trial `0.0513s -> 0.0560s` (`+0.0047s`)
