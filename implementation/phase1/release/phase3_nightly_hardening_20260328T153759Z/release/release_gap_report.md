...
- Generated at: `2026-03-28T15:37:42.665864+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=2): `5.29 min` (range `5.24-5.36 min`)
- Current measured chain wall-clock: `5.36 min`
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10)`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-28T15:37:37.206184+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=2): `5.29 min` (range `5.24-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=13` | `comparable_samples=2` | `reference_steps=18` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `5.36 min`
- Basis: `Empirical estimate derived from nightly design-optimization smoke runtime reduction, scaled by the accelerated-coverage target. smoke_mean_runtime_saved=95.88%, sample_count=7.`
- Empirical smoke runtime reduction: `95.38-96.24%` (mean `95.88%`)
- `measured_chain_breakdown_min`: parser/screening `0.17`, analysis/optimization `0.38`, nonseismic/construction `4.57`, authority/crosscheck `0.18`, release/packaging `0.06`
- `measured_chain_breakdown_mean_min`: parser/screening `0.15`, analysis/optimization `0.37`, nonseismic/construction `4.58`, authority/crosscheck `0.12`, release/packaging `0.07`
...
- `runtime_drift`: baseline `1.3002s -> 1.3750s` (`+0.0748s`), trial `0.0538s -> 0.0551s` (`+0.0013s`)
...
- `Design-optimization cost smoke probe is stable`: reason=PASS, pass_rate=100.00%, trial_feasible_rate=100.00%, history_count=7, strict_recommendation=candidate_for_strict_enable
