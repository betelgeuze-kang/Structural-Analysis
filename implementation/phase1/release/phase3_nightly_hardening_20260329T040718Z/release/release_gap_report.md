...
- Generated at: `2026-03-29T04:05:39.576901+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=13): `1.55 min` (range `0.59-5.36 min`)
...
- Solver breadth: `Solver breadth: PASS | shell=yes(elems=5,cases=31) | wall=yes(rows=2,cases=14,material=rc_composite) | interface=yes(ssi_nonlinear_boundary) | contact=full_structural_contact | general_fe_contact=yes(10/10) | surface_interaction=yes(7/7) | interaction_family=yes(185/185) | interaction_sources=10/10 | groups=shell-shell=59/59,shell-wall=59/59,footing-soil=59/59,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- Material constitutive gate: `Material constitutive gate: PASS | concrete_damage=yes(matrix=39/39,max=1.000) | cyclic_degradation=yes(matrix=38/38,residual_max=1.914%) | bond_interface=yes(matrix=40/40,bond_max=0.980) | matrix=117/117 | groups=concrete_damage=39/39,cyclic_degradation=38/38,bond_interface=40/40 | coverage=cd[t=2,h=2,s=2,sf=12],cyc[t=2,h=2,store=1,sf=12],bond[t=2,h=2,s=2,sf=12]`
...
- Surface interaction benchmark: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=185/185 | source_families=10/10 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=59/59,shell-wall=59/59,footing-soil=59/59,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- `material_constitutive_summary_line`: `Material constitutive gate: PASS | concrete_damage=yes(matrix=39/39,max=1.000) | cyclic_degradation=yes(matrix=38/38,residual_max=1.914%) | bond_interface=yes(matrix=40/40,bond_max=0.980) | matrix=117/117 | groups=concrete_damage=39/39,cyclic_degradation=38/38,bond_interface=40/40 | coverage=cd[t=2,h=2,s=2,sf=12],cyc[t=2,h=2,store=1,sf=12],bond[t=2,h=2,s=2,sf=12]`
...
- `surface_interaction_benchmark_summary_line`: `Surface interaction benchmark: PASS | ready=7/7 | family_matrix=185/185 | source_families=10/10 | shell_surface=yes | interface_transfer=yes | interface_gap=yes | foundation=yes | ssi=yes | soil_tunnel=yes | direct_contact=6/6 | groups=shell-shell=59/59,shell-wall=59/59,footing-soil=59/59,ssi=1/1,soil-tunnel=1/1,direct-contact=6/6`
...
- `mgt_export_audit_review_followup_reference_time_utc`: `2026-03-29T03:46:39.378615+00:00`
...
- Measured accelerated chain wall-clock (comparable rolling N=13): `1.55 min` (range `0.59-5.36 min`)
- Comparable run selection: `current_pipeline_comparable_full_chain_pass` | `full_chain_samples=24` | `comparable_samples=13` | `reference_steps=19` | `overlap_threshold=0.90` | `deployment_model=engineer_in_the_loop_accelerated_coverage` | `strict_smoke=True`
- Current measured chain wall-clock: `0.91 min`
...
- Empirical smoke runtime reduction: `95.8-96.11%` (mean `95.99%`)
- `measured_chain_breakdown_min`: parser/screening `0.16`, analysis/optimization `0.39`, nonseismic/construction `0.13`, authority/crosscheck `0.16`, release/packaging `0.07`
- `measured_chain_breakdown_mean_min`: parser/screening `0.16`, analysis/optimization `0.38`, nonseismic/construction `0.80`, authority/crosscheck `0.14`, release/packaging `0.06`
...
- `runtime_drift`: baseline `1.4464s -> 1.4433s` (`-0.0031s`), trial `0.0607s -> 0.0562s` (`-0.0045s`)
...
- `viewer review surface`: `the interactive Review surface mirrors the same Hazard and Rule Family slices used in this appendix.`
- `reverse jump`: `each appendix row carries viewer_row_url and viewer_slice_url back to the matching viewer row and slice.`
