#!/usr/bin/env python3
"""Generate a technically signed registry anchored to version-lock artifacts."""
...
try:
    ...
    from project_registry_service import (  # type: ignore
        LEGAL_CLAIM_BOUNDARY,
        TECHNICAL_CONTRACT_SEMANTICS,
        _no_legal_authority,
        build_project_registry,
...
REASONS = {
    "PASS": "technically signed release registry generated",
...
RELEASE_SIGNATURE_CLAIM_BOUNDARY = (
    "The release-registry Ed25519 signature verifies registry bytes only. The key may be generated by this "
...
def main() -> None:
    ...
    try:
        ...
        registry_body = {
            ...
            "signature_claim_boundary": RELEASE_SIGNATURE_CLAIM_BOUNDARY,
        ...
        checks = {
            ...
            "legal_authority_fail_closed_pass": registry_body.get("authority") == _no_legal_authority(),
        }
        ...
        if contract_pass:
            ...
            checks["project_registry_legal_authority_fail_closed_pass"] = (
                project_registry_payload.get("authority") == _no_legal_authority()
            )
            contract_pass = bool(all(checks.values()))
            reason_code = "PASS" if contract_pass else "ERR_SIGNATURE"
        else:
