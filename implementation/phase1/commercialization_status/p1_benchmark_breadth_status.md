...
| korean public structure collection report | `ready` | Korean source collect: PASS | sources=15 | collected=10 | metadata_only=5 | rejected=0 | bytes=12301 | seed_complete=15 | exact_topology=5 | native_writeback=5 | curated_local_ifc=5/5 | p0_focus=11 |
