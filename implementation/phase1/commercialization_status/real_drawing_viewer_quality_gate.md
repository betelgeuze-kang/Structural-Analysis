...
| Solver-exact assets | 7 |
| Proxy or preview assets | 11 |
| Review queue assets | 12 |
| Review items | 22 |
| Hard blockers | 0 |

- Quality flags: not_solver_exact=11, proxy_layout_not_true_geometry=7, proxy_node_glyph_fallback=1, sampled_dense_model=1, sparse_preview=2
...
| RD-012 | sparse_preview_review | sparse_preview, not_solver_exact | expand sparse preview into a complete solver-exact model |
| RD-013 | proxy_preview_review | not_solver_exact | replace proxy or preview topology with solver-exact structural geometry |
| RD-014 | proxy_preview_review | not_solver_exact | replace proxy or preview topology with solver-exact structural geometry |
| RD-017 | sparse_preview_review | sparse_preview, not_solver_exact | expand sparse preview into a complete solver-exact model |
