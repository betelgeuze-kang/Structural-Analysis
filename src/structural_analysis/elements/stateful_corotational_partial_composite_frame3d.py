...
class StatefulCorotationalPartialCompositeFrame3DResponse:
    ...
    claim_boundary: str = STATEFUL_COROTATIONAL_PARTIAL_COMPOSITE_FRAME3D_CLAIM_BOUNDARY
...
class StatefulCorotationalPartialCompositeFrame3D:
    ...
    def to_manifest(self) -> dict[str, Any]:
        ...
        return {
            ...
            "connector": {
                ...
                "initial_stiffness_n_per_m": (self.connector.initial_stiffness_n_per_m),
            ...
            "local_solver": {
                "absolute_tolerance_kn": (self.local_equilibrium_absolute_tolerance_kn),
    ...
    def validate_reference_section(
        ...
        *,
        ...
        tangent = np.asarray(
            self.steel_section.initial_consistent_tangent()
    ...
    def dissipated_energy_mj(
        ...
        return math.fsum(
            ...
            * (
                ...
                + connector.dissipated_energy_j * _J_TO_MJ / self.connector_spacing_m
            )
    ...
    def _local_response(
        ...
        for xi, weight, steel_parent, concrete_parent, connector_parent in zip(
            ...
            coupling += (
                frame_strain.T
                @ (steel_tangent @ steel_slip + concrete_tangent @ concrete_slip)
                * factor
            )
        ...
        if not all(
            ...
            raise RuntimeError(
                "distributed partial-composite local response is invalid"
            )
