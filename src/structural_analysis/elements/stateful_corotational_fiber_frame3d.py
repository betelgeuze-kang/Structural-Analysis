...
class StatefulCorotationalFiberFrame3DResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "initial_fiber_basic_tangent": (
                self.initial_fiber_basic_tangent.tolist()
            ),
...
class StatefulCorotationalFiberFrame3D:
    ...
    def to_manifest(self) -> dict[str, Any]:
        ...
        return {
            ...
            "reference_policy": (
                "elastic_timoshenko_plus_fiber_minus_initial_fiber"
            ),
    ...
    def dissipated_energy_mj(
        ...
        return math.fsum(
            weight
            * jacobian
            * self.section.dissipated_energy_mj_per_m(section_state)
