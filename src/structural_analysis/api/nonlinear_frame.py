...
UNIFIED_NONLINEAR_FRAME_CLAIM_BOUNDARY = (
    ...
    "uniform dead loads in the initial member-local axes. Automatic self-weight, "
    "user-rotated local axes, direct displacement control, and arc-length control "
    "remain outside this unified public slice. Both profiles remain "
