...
from structural_analysis.engine_v2.contracts.mdof_transient_result import (
    MDOF_TRANSIENT_AUTHORITY_PROFILE,
    MDOF_TRANSIENT_CLAIM_BOUNDARY,
    MDOF_TRANSIENT_RESULT_IR_SCHEMA_VERSION,
    MDOF_TRANSIENT_STORAGE_PROFILE,
    MDOFTransientResultIR,
    MDOFTransientResultIRError,
    MDOFTransientSampleIR,
...
from structural_analysis.engine_v2.contracts.nonlinear_mdof_transient_result import (
    NONLINEAR_MDOF_AUTHORITY_PROFILE,
    NONLINEAR_MDOF_CLAIM_BOUNDARY,
    NONLINEAR_MDOF_RESULT_IR_SCHEMA_VERSION,
    NONLINEAR_MDOF_STORAGE_PROFILE,
