  ...
  return (
    <section className="wb2-panel wb2-capabilities" aria-labelledby="wb2-capabilities-title">
      ...
      <p className="wb2-note">
        Solver truth owner: {registry.authorityRules.solver_truth_owner}. Workbench and AI
        authority remain {registry.authorityRules.workbench_truth_owner}; fallback promotion is
