...
CLAIM_BOUNDARY = (
    ...
    "narrow non-promoting OpenSees/CalculiX technical comparisons. The source mount "
    "was read-only, runtime networking had no default route, and every external "
    "asset matched its pinned SHA-256 before execution. It is not an independent "
    "operator attestation, legal approval, Verification Level 2 promotion, broad "
    "structural-family validation, commercial equivalence, design authority, or "
    "release readiness."
)
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "blockers_remaining": [
            ...
            "public_corotational_nonlinear_external_family_missing",
