...
- PM release milestone gate: **M1-M5 5/5 pass**, release evidence freshness pass, release areas는 CI streak, human UX observation, license status, GitHub sync local-head mismatch 때문에 blocked (`12/16` green)
