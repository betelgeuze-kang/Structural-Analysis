...
- PM release milestone gate: **M1-M5 5/5 pass**, release evidence freshness pass, release areas는 CI streak, human UX observation, license status 때문에 blocked (`13/16` green); GitHub sync는 현재 synced
