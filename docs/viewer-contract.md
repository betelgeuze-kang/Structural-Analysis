...
- Large raw datasets remain a P0 source-boundary item: tracked stress/workspace/output/rust target artifacts have been removed from Git tracking, and the remaining 25MiB+ data need an explicit allowlist vs externalization decision before release closure.
