...
- The 3D source viewer keeps reusable browser/state helpers in ESM sidecars such as `viewer-real-drawing-browser-state.js`; release generators must inline those helpers for single-file delivery.
