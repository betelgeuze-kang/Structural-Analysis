...
| Corotational 2D fiber-frame portal compiler | experimental | no | replay_bound_portal_convergence_candidate_no_result_authority | internal_python | planar_one_bay_one_story_portal_explicit_fiber_section_j1_j5.v1; One-bay, one-story load-control CPU dense portal candidate only; no public API, exact recovery, general topology, member features, independent Level 2 verification, or release promotion. |
