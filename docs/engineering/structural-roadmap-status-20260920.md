...
| Learned warm starts with split and cost discipline | [Nested labels and fixed gates](rc-nested-switch-results-20260920.md) provide 1,980 passing local comparisons and five outer-group-excluded gates. [Full-path follow-up](rc-guarded-runtime-results-20260920.md) passes 45 comparisons/180 paths but declines all 540 decisions; guarded/secant ratio 1.005186 fails eligibility. 1,170 numerical/context file pairs exactly match secant. [Cost-margin follow-up](rc-cost-margin-gate-results-20260920.md) changes the target to measured relative cost but selects ten training false positives and no true positives; no full-path promotion follows. | Useful learned decisions on sufficiently diverse excluded groups and untouched project/geometry/history evaluation, with full costs. Preserve the negative gate result; no post-hoc threshold change qualifies as independent confirmation. Secant remains supported. |
...
| Broader planar/sparse and later material/3D capability | [1,024-layer full-history study](planar-1024-refinement-20260920.md): 40 targets complete, 400 nodal/steel comparisons pass; concrete failures decrease 70/240 → 34/240 → 27/240 → 14/240 across successive layer pairs. | The original local 1% screen still fails: 13 tensile-damage groups and one compression-damage group. Tensile maximum is 2.147%, while compression rebounds from 0.856% to 1.201% at a different witness. Uniform convergence is not proved. Sparse speed, broader complete paths, independent physics and each new material/3D scope remain unproved. |
