...
`model-edit-constraint-value` existing-restrained-DOF commands. Distribution E2E v18 proves
repeated edited model/receipt bytes, exact load/constraint identity, DOF, unit and value bindings,
