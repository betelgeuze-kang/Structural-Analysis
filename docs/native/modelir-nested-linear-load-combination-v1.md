...
editing one typed root factor, and replacing one typed root reference. Those separate surfaces are documented in
...
bounded root-factor and root-reference editors, nonterminal or downstream-referenced editing, cascading or general
