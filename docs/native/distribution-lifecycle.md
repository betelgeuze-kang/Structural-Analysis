...
36. emits an append-only v34 hash-bound receipt with ModelIR/MGT result, report, MGT source,
   ...
   The receipt checker continues to accept frozen v1 through v33 receipts; v1 through v19 are not
   ...
   fixed-constraint deletion, restored-active-DOF/load, typed recovery and restart authority.
