...
9. emits an append-only v6 hash-bound receipt with ModelIR/MGT result, report, MGT source,
   import-health, review, export, catalog-builder check/build/output,
   evidence-builder check/build/manifest, catalog and evidence-view
   identities, Python/Node lookup count 0 and fallback count 0. The receipt checker continues to
   accept frozen v1/v2/v3/v4/v5 receipts without treating them as v6 catalog-builder authority.
