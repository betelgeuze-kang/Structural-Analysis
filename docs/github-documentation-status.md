...
| Release evidence freshness | pass: `9/9` artifacts include generated_at/source commit/engine version/input checksum/reuse marker and producer mtime recency; customer shadow/full-validation/residual/G1 freshness does not close the `0/3` shadow-case, `0/8` fresh-receipt, G1 full-mesh nonlinear-equilibrium, or GA breadth blockers |
