...
| Release evidence freshness | pass: `7/7` artifacts include generated_at/source commit/engine version/input checksum/reuse marker and producer mtime recency; customer shadow/full-validation/residual freshness does not close the `0/3` shadow-case, `0/8` fresh-receipt, or GA breadth blockers |
