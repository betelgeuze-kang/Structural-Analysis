...
- Version: 0.2.32
- 기준일: 2026-07-14
- 감사 기준: local/upstream 동기화 commit `a990642e049f17b46211d43af9cef2263a085b7b` 이후 package fixture registry와 registry-bound model-family parity v2 작업 (`origin/main` 포함으로 해석하지 않음)
...
- 별도 trust-anchor의 외부 actual `gfx1100` signed cell `0/10`과 signed promotion evidence v2; local unsigned `gfx1030` fixed-suite는 v0.2.32에서 `10/10` 완료했지만 이를 multiarchitecture 또는 release promotion으로 승격하지 않음
