...
Commercial scope stays bounded in this handoff path: `Commercial`, `engineer_in_loop_accelerated_coverage_ready=true`, `full_commercial_replacement_ready=false`. Until the EB/RH evidence sidecars are materialized, EB receipt remains `0/4` and RH closure evidence remains pending.
