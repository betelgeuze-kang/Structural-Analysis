...
configured proportional-load path. It publishes no engineering result. Its
resume hash binds the canonical model, compiler and problem contracts, full
load-factor sequence, tolerances, iteration limit, and matrix backend.
