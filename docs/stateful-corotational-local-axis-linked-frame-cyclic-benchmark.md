...
follower external loads and coupled multi-axis constitutive
...
interaction remain open. A separate
[scalar rotational-link benchmark](stateful-corotational-rotational-linked-frame-cyclic-benchmark.md)
covers one relative-`rz` moment-rotation link only; it does not close those
broader families. No external device acceptance, production sparse or
