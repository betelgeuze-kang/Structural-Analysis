...
- Customer shadow evidence는 schema/validator가 준비됐고 `check_customer_shadow_evidence_status.py`로 3~5개 completed-project shadow case 목표를 추적한다. 현재는 실제 customer-retained evidence file이 없어 `0/3` blocked이며, synthetic/placeholder case로 닫으면 안 된다.
