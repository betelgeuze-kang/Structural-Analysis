...
def build_report(
    ...
    *,
    ...
    if 137 not in numbers:
        blockers.append("required_pr_137_inventory_row_missing")
    for row in pull_requests:
    ...
    return {
        ...
        "observed_default_branch_head": inventory.get(
        ...
        "external_actions_performed": inventory.get(
