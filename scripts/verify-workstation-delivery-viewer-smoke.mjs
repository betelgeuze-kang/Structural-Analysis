...
function staticViewerChecks(extractRoot, packagePath) {
  ...
  const commercialMarkers = {
    ...
    stage_result_callouts: viewerText.includes('data-stage-callout-focus-member') && viewerText.includes('structure-viewer-stage-result-callouts.v2') && viewerText.includes('data-stage-result-callout-source-type') && viewerText.includes('data-stage-result-callout-full-value'),
