#!/usr/bin/env python3
"""Compatibility entry point for the bounded planar linear package."""
...
from scripts import build_bounded_planar_external_linear_case_package_core as _core  # noqa: E402
