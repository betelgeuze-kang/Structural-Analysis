...
def check_native_deployment_cutover(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    _require_tokens(
        ...
        tokens=(
            ...
            "frozen v1 through v10 rootfs receipts",
    ...
    if not isinstance(capability, dict):
        ...
        for token in (
            ...
            "v11 self-hashed local_rootfs_diagnostic_c5 receipt",
        ...
        if evidence_contract != {
            "latest_rootfs_receipt_schema": "structural-native-rootfs-isolation-e2e.v11",
            "frozen_rootfs_receipts": "v1-v10",
            "required_installed_receipt_schema": "structural-native-distribution-e2e.v88",
