...
def check_native_deployment_cutover(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    if not isinstance(capability, dict):
        ...
        if evidence_contract != {
            "latest_rootfs_receipt_schema": "structural-native-rootfs-isolation-e2e.v20",
            "frozen_rootfs_receipts": "v1-v19",
            "required_installed_receipt_schema": "structural-native-distribution-e2e.v98",
        ...
        for token in (
            "local rootfs diagnostic v20",
            "installed distribution v98",
            "Workbench Frame3D linear-buckling request authoring",
            "eighteen-artifact direct/resumed CLI product",
            "two modes over six active DOFs",
            "twelve identities",
            "UID/GID 65532",
            "empty PATH",
            ...
            "frozen rootfs receipts remain v1-v19",
