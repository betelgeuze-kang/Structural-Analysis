...
def check_native_deployment_cutover(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    if not isinstance(capability, dict):
        ...
        if evidence_contract != {
            "latest_rootfs_receipt_schema": "structural-native-rootfs-isolation-e2e.v19",
            "frozen_rootfs_receipts": "v1-v18",
            "required_installed_receipt_schema": "structural-native-distribution-e2e.v97",
        ...
        for token in (
            "local rootfs diagnostic v19",
            "installed distribution v97",
            "Workbench prescribed-value and combination authoring",
            "F_a-K_ac*u_c",
            "eight identities",
            "UID/GID 65532",
            "empty PATH",
            ...
            "frozen rootfs receipts remain v1-v18",
