...
REQUIRED_PATHS = (
    ...
    Path("native/crates/structural-workbench/src/element_recovery_view.rs"),
    Path("native/crates/structural-workbench/src/model_view.rs"),
    Path("native/crates/structural-workbench/src/nodal_displacement_view.rs"),
    ...
    Path("docs/native/modelir-linear-load-pattern-identity-cascade-edit-v2.md"),
    ...
    Path("docs/native/modelir-linear-nodal-displacement-view-v1.md"),
    Path("docs/native/modelir-linear-element-recovery-view-v1.md"),
...
EXPECTED_FEATURES = {
    ...
    "bounded_cpp_revalidated_existing_modelir_fixed_constraint_single_dof_reorder": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_last_neutral_nodal_load_delete": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_two_pattern_linear_load_combination_execution": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_two_to_64_direct_linear_load_combination_authoring_execution": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_direct_linear_load_combination_factor_edit": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_direct_linear_load_combination_reference_edit": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_direct_linear_load_combination_term_reorder": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_nested_linear_load_combination_term_add": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_nested_linear_load_combination_reference_edit": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_last_neutral_two_to_64_direct_linear_load_combination_delete": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_last_neutral_acyclic_nested_linear_load_combination_delete": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_last_neutral_linear_static_load_pattern_delete": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_last_neutral_linear_elastic_material_delete": (
        "c5_implemented",
        False,
    ),
    "bounded_cpp_revalidated_last_neutral_frame3d_section_delete": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_last_neutral_truss3d_section_delete": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_cpp_revalidated_last_neutral_frame3d_leaf_member_delete": (
        "c5_implemented",
        False,
    ),
    ...
    "bounded_modelir_linear_nodal_displacement_view_en_us_ko_kr": (
        "c5_implemented",
        False,
    ),
    "bounded_modelir_linear_element_recovery_view_en_us_ko_kr": (
        "c5_implemented",
        False,
    ),
...
def check_native_workbench_ui_transition(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    native_nodal_displacement_view = _text(
        root,
        Path("native/crates/structural-workbench/src/nodal_displacement_view.rs"),
        blockers,
    )
    _require_tokens(
        Path("native/crates/structural-workbench/src/nodal_displacement_view.rs"),
        native_nodal_displacement_view,
        (
    ...
    native_element_recovery_view = _text(
        root,
        Path("native/crates/structural-workbench/src/element_recovery_view.rs"),
        blockers,
    )
    ...
    _require_tokens(
        ...
        (
            ...
            "structural-native:model-edit-linear-load-pattern-identity-cascade.v2",
    ...
    _require_tokens(
        ...
        (
            ...
            'Some("evidence")',
            'Some("evidence-show")',
            'Some("model-edit-model-identity")',
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-combination-add-v1.md"),
        linear_load_combination_add_doc,
        (
            "model-add-linear-load-combination",
            "single C ABI",
            "structural-native:model-add-linear-load-combination.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-combination-execution-v1.md"),
        linear_load_combination_execution_doc,
        (
            "load-case selector",
            "exactly two terms",
            "structural-native-model-linear-combination-request-create-receipt.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-v1.md"),
        direct_linear_load_combination_doc,
        (
            "two through 64",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-factor-edit-v1.md"),
        direct_linear_load_combination_factor_edit_doc,
        (
            "model-edit-linear-load-combination-factor",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-reference-edit-v1.md"),
        direct_linear_load_combination_reference_edit_doc,
        (
            "model-edit-linear-load-combination-reference",
            "two through 64 ordered",
            "single C ABI into C++",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-deletion-v1.md"),
        direct_linear_load_combination_deletion_doc,
        (
            "model-delete-linear-load-combination",
            "two through 64",
            "structural-native:model-delete-direct-linear-load-combination.v2",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-term-delete-v1.md"),
        direct_linear_load_combination_term_delete_doc,
        (
            "model-delete-linear-load-combination-term",
            "three through 64",
            "single C ABI into C++",
    ...
    _require_tokens(
        Path("docs/native/modelir-direct-linear-load-combination-term-reorder-v1.md"),
        direct_linear_load_combination_term_reorder_doc,
        (
    ...
    _require_tokens(
        Path("docs/native/modelir-nested-linear-load-combination-term-add-v1.md"),
        nested_linear_load_combination_term_add_doc,
        (
            "model-add-nested-linear-load-combination-term",
            "two through 63",
    ...
    _require_tokens(
        Path("docs/native/modelir-nested-linear-load-combination-term-delete-v1.md"),
        nested_linear_load_combination_term_delete_doc,
        (
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-pattern-deletion-v1.md"),
        linear_load_pattern_deletion_doc,
        (
            "model-delete-linear-load-pattern",
            "Rust -> C ABI -> C++",
            "structural-native:model-delete-linear-load-pattern.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-material-deletion-v1.md"),
        linear_material_deletion_doc,
        (
            "model-delete-linear-material",
            "Rust -> C ABI -> C++",
            "structural-native:model-delete-linear-material.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-frame-section-deletion-v1.md"),
        frame_section_deletion_doc,
        (
            "model-delete-frame-section",
            "Rust -> C ABI -> C++",
            "structural-native:model-delete-frame-section.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-fixed-constraint-dof-reorder-v1.md"),
        fixed_constraint_dof_reorder_doc,
        (
            "model-reorder-fixed-constraint-dof",
            "single C ABI into C++",
            "structural-native:model-reorder-fixed-constraint-dof.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-material-identity-edit-v1.md"),
        linear_material_identity_edit_doc,
        (
            "model-edit-linear-material-identity",
            "single C ABI into C++",
            "structural-native:model-edit-linear-material-identity.v1",
    ...
    _require_tokens(
        Path("docs/native/modelir-frame-section-identity-edit-v1.md"),
        frame_section_identity_edit_doc,
        (
            "model-edit-frame-section-identity",
            "single C ABI into C++",
            "structural-native:model-edit-frame-section-identity.v1",
    ...
    load_pattern_identity_cascade_doc = _text(
        root,
        Path("docs/native/modelir-linear-load-pattern-identity-cascade-edit-v2.md"),
        blockers,
    )
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-material-identity-cascade-edit-v2.md"),
        linear_material_identity_cascade_doc,
        (
            "model-edit-linear-material-identity-cascade",
            "single C ABI into C++",
            "structural-native:model-edit-linear-material-identity-cascade.v2",
    ...
    _require_tokens(
        Path("docs/native/modelir-frame-section-identity-cascade-edit-v2.md"),
        frame_section_identity_cascade_doc,
        (
            "model-edit-frame-section-identity-cascade",
            "single C ABI into C++",
            "structural-native:model-edit-frame-section-identity-cascade.v2",
    ...
    _require_tokens(
        Path("docs/native/modelir-truss-section-identity-cascade-edit-v2.md"),
        truss_section_identity_cascade_doc,
        (
            "model-edit-truss-section-identity-cascade",
            "single C ABI into C++",
            "structural-native:model-edit-truss-section-identity-cascade.v2",
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-pattern-identity-cascade-edit-v2.md"),
        load_pattern_identity_cascade_doc,
        (
            "model-edit-linear-load-pattern-identity-cascade",
            "single C ABI into C++",
            "structural-native:model-edit-linear-load-pattern-identity-cascade.v2",
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-combination-identity-edit-v1.md"),
        linear_load_combination_identity_edit_doc,
        (
            "model-edit-linear-load-combination-identity",
            "single C ABI into C++",
            "structural-native:model-edit-linear-load-combination-identity.v1",
    ...
    linear_load_combination_identity_cascade_edit_doc = _text(
        root,
    ...
    _require_tokens(
        Path("docs/native/modelir-linear-load-combination-identity-cascade-edit-v2.md"),
        linear_load_combination_identity_cascade_edit_doc,
        (
            "model-edit-linear-load-combination-identity-cascade",
            "single C ABI into C++",
            "structural-native:model-edit-linear-load-combination-identity-cascade.v2",
    ...
    element_recovery_view_doc = _text(
        root,
        Path("docs/native/modelir-linear-element-recovery-view-v1.md"),
        blockers,
    )
    ...
    _require_tokens(
        ...
        (
            ...
            "bounded ModelIR linear element-recovery view is C5-implemented",
    ...
    expected_extension_claim = (
        ...
        "ModelIR-linear nodal-displacement, element-recovery, bounded deformed-centerline and "
        "constrained-reaction views, algebraic "
        "global-resultant reaction audit, installed distribution v87/rootfs v10 "
        "nodal-displacement evidence, installed distribution v88/rootfs v11 bounded "
        "deformed-centerline evidence, and installed distribution v89/rootfs v12 Frame3D "
        "element-recovery evidence"
    )
