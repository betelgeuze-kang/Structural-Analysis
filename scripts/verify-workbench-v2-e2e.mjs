...
if (withJobApi) specs.push('tests/frontend/workbench-v2-job-api-browser.spec.ts', 'tests/frontend/workbench-v2-failure-diagnostic-browser.spec.ts', 'tests/frontend/workbench-v2-rc-search-http-browser.spec.ts', 'tests/frontend/workbench-v2-rc-cohort-http-browser.spec.ts')
