...
def _receipt_commit_allowed_path(path: str, allowed_paths: set[str]) -> bool:
    ...
    if (
        ...
        or path.startswith("implementation/phase1/release_evidence/gpu/")
...
def _artifact_relevant_source_path(artifact_name: str, path: str) -> bool:
    ...
    artifact_specific_paths = {
        ...
        "developer_preview_rc_status": {
            ...
            "scripts/fill_phase6_windows_platform_replay_receipt.py",
        ...
        "non_snapshot_product_surfaces": {
            ...
            "scripts/build_g1_load_dependent_near_null_packet.py",
            ...
            "implementation/phase1/structural_runtime_ffi/Cargo.lock",
            "implementation/phase1/structural_runtime_ffi/Cargo.toml",
            "implementation/phase1/structural_runtime_ffi/src/contracts.rs",
            "implementation/phase1/structural_runtime_ffi/src/ffi.rs",
            "implementation/phase1/structural_runtime_ffi/src/lib.rs",
            "implementation/phase1/structural_runtime_ffi/src/runtime.rs",
        ...
        "ux_new_user_observation_report": {
            ...
            "scripts/fill_ux_new_user_observation_from_human_sample.py",
