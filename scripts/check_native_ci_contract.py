...
def check_native_ci_contract(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    for name in WINDOWS_HOSTED_CHILDREN:
        ...
        for required in (
            ...
            "structural-native-windows-install-lifecycle-receipt.v1",
            "structural-native-windows-static-distribution-receipt.v1",
            '"install"',
            '"update"',
            '"rollback"',
            '"status"',
            ...
            "shared/static deterministic structural-distribution",
