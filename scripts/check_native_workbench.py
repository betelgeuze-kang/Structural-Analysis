...
REQUIRED_TOKENS = {
    ...
    "native/crates/structural-workbench/tests/native_workbench_e2e.rs": (
        ...
        "linear_material_identity_cascade_edit_is_atomic_restartable_and_cpu_executable",
        "linear_load_pattern_identity_cascade_edit_is_atomic_restartable_and_cpu_executable",
        "frame_section_edit_is_provenance_bound_cpp_revalidated_and_create_new",
        "frame_section_identity_cascade_edit_is_atomic_restartable_and_cpu_executable",
        "truss_section_identity_cascade_edit_is_atomic_restartable_and_cpu_executable",
    ...
    "docs/native/modelir-linear-nodal-displacement-view-v1.md": (
        ...
        "Installed static/shared distribution v87",
        "Local rootfs diagnostic v10",
        "038a2b868ac89ebb6790222071071f933a542ef6",
        "e57f5733e787c932999896de64a08bb9b35179c4aa2cad046a92bb60c6e6a885",
        "943f021c218615e5e41178691085382343440cbe887a0a0c0d96f0ad05cdd159",
    ...
    "docs/native/modelir-truss-section-identity-edit-v1.md": (
    ...
    "docs/native/modelir-element-identity-cascade-edit-v2.md": (
    ...
    "docs/native/modelir-model-identity-edit-v1.md": (
    ...
    "docs/native/modelir-node-identity-cascade-edit-v2.md": (
...
def check_native_workbench(repo_root: Path = ROOT) -> dict[str, object]:
    ...
    for token in (
        ...
        "frozen pre-reaction compatibility",
        "installed static/shared CPU distribution v87",
        "local rootfs diagnostic v10",
    ...
    for token in (
        ...
        "byte-identical strict-ModelIR and normalized-MGT direct/restart views",
        "frozen pre-reaction compatibility",
        "installed static/shared CPU distribution v88",
        "local rootfs diagnostic v11",
    ...
    for token in (
        ...
        "installed static/shared CPU distribution v85",
        "local rootfs diagnostic v8",
        "public/customer distribution publication",
        "HIP C2",
        "C6",
    ):
    ...
    for token in (
        ...
        "installed static/shared CPU distribution v86",
        "local rootfs diagnostic v9",
        "support design",
        "HIP C2",
        "C6",
    ):
    ...
    for token in (
        ...
        "provenance-bound editors cover the root model identity",
        "typed-reference-cascading node identity",
        "node coordinates",
        "nodal loads",
