    ...
    if isinstance(value, dict):
        for key, child in value.items():
            ...
            exact_pointer_keys = {
                ...
                ("bounded_planar_external_vv", "summary"): frozenset({"requirement_count", "technical_reference_present_count", "fresh_current_source_technical_count", "current_product_replay_only_count", "current_product_replay_failed_count", "fresh_external_technical_count", "fresh_independent_preflight_technical_count", "promotion_eligible_count", "missing_count", "execution_package_available_count", "current_source_execution_prepared_count"}),
                ("bounded_planar_external_vv", "stored_summary"): frozenset({"requirement_count", "technical_reference_present_count", "fresh_current_source_technical_count", "current_product_replay_only_count", "current_product_replay_failed_count", "fresh_external_technical_count", "fresh_independent_preflight_technical_count", "promotion_eligible_count", "missing_count", "execution_package_available_count", "current_source_execution_prepared_count"}),
