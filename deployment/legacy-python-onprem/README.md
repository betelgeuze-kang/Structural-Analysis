# Archived Python On-Prem And Air-Gapped Packaging Contract

This directory is rollback-only compatibility evidence. It has no active workflow or product
deployment authority. New installations use `deployment/onprem` and the native distribution.
